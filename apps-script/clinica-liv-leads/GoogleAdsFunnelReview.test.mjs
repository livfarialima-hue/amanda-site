...
test("o agregado preserva as dez rotas secundárias atuais e transitórias", () => {
  const build = load("construirAgregadosRotasGoogleAds_");
  ...
  const fixtures = [
    ["opp_mama_preco_transitorio", "G26MAMA", "ag_cirurgia_mama_preco", "/conteudos/quanto-custa-cirurgia-plastica-mama-sao-paulo/"],
    ...
    ["opp_corp_preco_transitorio", "G26CORP", "ag_contorno_corporal_preco", "/conteudos/quanto-custa-cirurgia-plastica-corporal-sao-paulo/"],
  ...
  assert.equal(resolved7.length, 10);
  assert.deepEqual(
