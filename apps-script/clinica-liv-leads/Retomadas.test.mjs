...
test("contextual copy resumes a name-only opening with one easy question and no evaluation pitch", () => {
  ...
  assert.equal(body,"Olá! Sobre lifting cervical, você prefere entender como funciona o procedimento ou como são definidos os valores?");
...
test("contextual copy changes the entry point after an unanswered discovery question", () => {
  ...
  assert.match(body,/como funciona o procedimento ou como são definidos os valores/);
...
test("contextual copy does not invent personal engagement from qualified status", () => {
  ...
  assert.match(body,/Sobre lifting facial/);
  assert.doesNotMatch(body,/Você comentou|começando a pesquisar/);
});
...
test("prefill-only candidate receives a contextual continuation without agenda", () => {
  ...
  assert.match(candidate.sugestao, /Sobre lifting facial/);
  assert.match(candidate.sugestao, /como funciona o procedimento ou como são definidos os valores/);
...
test("contextual first follow-up names the procedure without offering agenda", () => {
  ...
  assert.match(message, /Sobre lifting facial/);
  assert.match(message, /como funciona o procedimento ou como são definidos os valores/);
...
test("follow-up sequence stays warm, unhurried and respectful", () => {
  ...
  assert.match(price, /os valores/);
  assert.match(schedule, /duas opções reais/);
  assert.match(general, /Sobre lifting facial/);
  assert.match(general, /como funciona o procedimento ou como são definidos os valores/);
...
test("every contextual follow-up uses a safe first name and the known conversation point", () => {
  ...
  assert.match(surgicalPrice, /valores de lifting facial/);
