...
- Versão canônica: `111`, publicada no deployment existente em 21/08/2026.
...
- Produção atual: Apps Script versão `111`, publicada no deployment canônico em 21/08/2026. O agregado Google foi introduzido na v92 e preservado nas versões seguintes.
