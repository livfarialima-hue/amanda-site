...
- Versão canônica: `103`, publicada no deployment existente em 19/08/2026.
...
- Produção atual: Apps Script versão `103`, publicada no deployment canônico em 19/08/2026. O agregado Google foi introduzido na v92 e preservado nas versões seguintes.
