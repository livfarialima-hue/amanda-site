...
- Versão canônica: `107`, publicada no deployment existente em 20/08/2026.
...
- Produção atual: Apps Script versão `107`, publicada no deployment canônico em 20/08/2026. O agregado Google foi introduzido na v92 e preservado nas versões seguintes.
