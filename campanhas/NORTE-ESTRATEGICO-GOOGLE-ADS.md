...
**14/09/2026 — continuidade site → WhatsApp: candidato validado localmente, publicação autorizada.** Ref. SITE não é pedido de link. A origem Google/Meta permanece na atribuição, enquanto a passagem pelo site orienta a conversa. Responder à dúvida no WhatsApp e fazer uma única pergunta pertinente ao objetivo; sem devolução espontânea à página de origem, repetição de pergunta respondida ou coleta prematura de horários. Pedido explícito de material ou reenvio permite o link pertinente. Maps e guias de preço aprovados preservados. Evidência: `auditorias/bruna-site-contexto-2026-09-14/RELATORIO.md`. Hipótese: reduzir atrito e favorecer continuidade; avaliar links repetidos, dúvidas respondidas, intervenção humana, qualificados e consultas com evidência própria. Sem mudança em campanhas, orçamento, preço ou atribuição. Revisões em 16/09 e 21/09 às 17h30 BRT; manter se reduzir repetição sem silêncio indevido, conter diante de regressão de resposta, takeover ou agenda.
<!-- /BRUNA-SITE-CONTEXTO-2026-09-14 -->
