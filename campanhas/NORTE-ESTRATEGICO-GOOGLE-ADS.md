...
**Estrutura e destinos:** manter intenção de procedimento em `AG_MASTOPEXIA` → `/mastopexia/`, `AG_MAMOPLASTIA_REDUTORA` → `/mamoplastia-redutora/`, `AG_PROTESE_MAMA` → `/protese-de-mama/`, `AG_ABDOMINOPLASTIA` → `/abdominoplastia/` e `AG_LIPOASPIRACAO` → `/lipoaspiracao/`. A alteração autorizada de 12/09/2026 cria `AG_CIRURGIA_MAMA_PRECO` → `/conteudos/quanto-custa-cirurgia-plastica-mama-sao-paulo/` e `AG_CONTORNO_CORPORAL_PRECO` → `/conteudos/quanto-custa-cirurgia-plastica-corporal-sao-paulo/`, move para eles somente as oito palavras ativas de preço/valor e instala seis negativas exatas nos grupos de origem. Até existir recibo de aplicação, os cinco grupos publicados continuam sendo o estado vivo; não declarar os dois novos grupos como ativos por antecipação.
