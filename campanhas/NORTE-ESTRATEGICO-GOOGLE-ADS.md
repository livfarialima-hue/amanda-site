...
**Pacote 2026-09-26.3 — PUBLICADO E VERIFICADO em 26/09/2026, 09:57 BRT.** Commit funcional d3df40c136c51c0c83bc2a07e3145f99c1032f09, Netlify 6ab7c11ced13e90009556ee4; Apps Script v161 preservado. Validação: 1.763 testes integrais, 26 novas regressões e 28 comandos sem falhas. Domínio e URL imutável com automação ativa e assinatura protegida; requisições sem assinatura retornam 401. Treze funções, cinco programações, quatro atualizações de função e nenhum novo arquivo estático enviados. A primeira conversa natural após a publicação ainda não foi observada. Cada pergunta do bloco sobre consulta, cirurgia, convênio, atendimento online e relatório de reembolso recebe uma resposta confirmada, um esclarecimento essencial ou uma pendência específica. Consulta presencial R$ 500 e atendimento particular com nota fiscal são fatos confirmados. Atendimento online, seu valor e emissão de relatório exigem confirmação da equipe; nenhuma garantia de reembolso. Essas pendências só podem gerar promessa ao paciente depois do alerta entregue.
...
**Ajuste de abordagem e qualificação — publicado em 14/09/2026, commit bef9c1e:** a análise das 24 exportações motivou correções de atendimento e processo, sem alteração de campanhas, orçamento, lances ou valores. Pergunta inicial de preço, pesquisa genérica e ciência de informação não comprovam prontidão para agenda; pergunta de preço só é objeção financeira com manifestação explícita. Interesse pessoal compatível pode ser qualificado sem já ter escolhido horário; avanço administrativo exige evidência própria. Anexo, legenda de comprovante ou conversa sobre duas pessoas no mesmo telefone não confirmam pagamento ou consulta. Acolhimento deve reconhecer a preocupação concreta, responder às dúvidas pendentes e propor somente o próximo passo adequado. Hipótese: reduzir atrito e correções melhora a passagem de contato válido para consulta, sem pressão sobre recusas. Métricas: qualificados com evidência, agendamentos, comparecimentos e correções humanas; acompanhar também pendências CRM–Central, identificação incorreta e duplicidades. Revisar em 48 horas e sete dias após publicação autorizada. Manter se a integridade melhorar sem avanço indevido; conter a função afetada diante de identificação errada, recontato indevido ou repetição de envio. Evidência: auditorias/bruna-experiencia-processo-2026-09-14/RELATORIO.md. Publicação autorizada do SHA `bef9c1e1e4ef49e6bd604688adddebc1be69eb02`, Apps Script v153 e Netlify `6aa7e218d56b0f48420dcd98`. Revisões em 16/09 e 21/09 às 09h02 BRT. Primeiro ciclo técnico observado; ganho de conversão ainda não demonstrado.

**Status:** fonte canônica da estratégia de aquisição digital e conversão

**Responsáveis:** Daniel e Dra. Amanda Schroeder

**Criado em:** 9 de agosto de 2026

**Última revisão estratégica:** 13 de setembro de 2026
**Próxima revisão prevista:** integridade em 24 horas; leitura D+7/D+14 e decisão em D+30 dos pilotos secundários de mama e corpo; para o piloto LIFT ativado em 13/09 às 21h04 BRT, D+7 em 20/09, D+14 em 27/09 e D+28 em 11/10, ou antes diante de regressão técnica, gasto anormal ou perda de atribuição

## 1. Regra de governança

Este é o documento principal para as decisões de aquisição digital e da jornada de conversão que começa na descoberta da Dra. Amanda e termina em consulta ou cirurgia. Seu escopo inclui Google Ads, busca orgânica, presença local, descoberta em buscadores com IA, páginas de destino, mensuração e continuidade no WhatsApp.

Sempre que houver mudança de posicionamento, prioridade de procedimentos, público, objetivo, orçamento total, estrutura de campanhas, conversão principal, estratégia de lances, critério de qualificação, arquitetura do site, página de destino, abordagem comercial ou regra de avaliação, este documento deve ser atualizado no mesmo trabalho.

Cada mudança estratégica deve registrar:

1. o que mudou;
2. por que mudou;
3. qual evidência motivou a decisão;
4. qual resultado se espera;
5. quando será revisada;
6. qual é a regra para manter, ampliar ou reverter.

Os demais documentos do projeto são manuais técnicos, planos de implementação, diagnósticos ou históricos. Em caso de divergência estratégica, este documento prevalece. Eles só precisam ser alterados quando a mudança também afetar sua execução específica.

As informações deste documento têm quatro naturezas e não devem ser confundidas:

- **Princípio estratégico:** orientação duradoura, alterada somente por decisão explícita.
- **Decisão vigente:** escolha atualmente aprovada, com métrica e regra de revisão.
- **Hipótese em teste:** experimento temporário que ainda não deve ser generalizado.
- **Estado conhecido:** retrato datado da conta ou do funil, sujeito a reconciliação.

A auditoria integrada pode questionar qualquer decisão vigente e propor alterações, inclusive aumento de investimento, novas páginas ou novas campanhas. Ela não pode transformar hipóteses em estratégia, atualizar este documento ou implementar mudanças externas sem revisão e aprovação de Daniel e da Dra. Amanda.
...
Esse benefício facilita o cuidado e a organização do preparo; a indicação clínica continua individualizada. A confirmação comercial posteriormente registrada na seção 29 permite esclarecer que a consulta cardiológica pré-operatória está incluída no pacote cirúrgico, sem confundi-la com a primeira consulta com Amanda ou estender a inclusão a exames. Os anúncios desta revisão mantêm a formulação condicional, sem usar a inclusão como promoção. A publicidade infantil não presume atendimento cardiológico pediátrico. Segurança e naturalidade não são diferenciais exclusivos comprovados perante concorrentes: o posicionamento os torna concretos e verificáveis na experiência da clínica.

O complemento entra no mesmo marco de revisão de 12/09/2026, com as mesmas métricas, datas e regras de correção. O banco editorial final é `auditorias/google-ads-comunicacao-2026-09-12/REVISAO-COMUNICACAO-GOOGLE-ADS-2026-09-12-SEGURANCA.json`; o banco inicial fica apenas como histórico da primeira etapa. Diretrizes operacionais detalhadas no guia de linguagem, sem alteração do site nesta tarefa.

**Aplicação confirmada em 12/09, à noite:** 17 RSAs das oito campanhas ativas foram revisados, totalizando 236 títulos e 68 descrições; 29 associações de frases de destaque e oito modelos de sitelink em 12 associações também foram alterados e relidos. A listagem final confirmou os 17 anúncios ativados e qualificados; recursos novos permaneciam em análise. Foi feita releitura adicional dos campos completos de nove RSAs, com equivalência exata ao banco. Não houve mudança de site, orçamento, lances, segmentação, palavras, metas, URLs, caminhos ou rastreamento por este pacote. O recibo e suas limitações estão em `REVISAO-COMUNICACAO-GOOGLE-ADS-2026-09-12.md` e `auditorias/google-ads-comunicacao-2026-09-12/REVISAO-COMUNICACAO-GOOGLE-ADS-2026-09-12-VERIFICACAO.json`. A aprovação do Google e o resultado comercial não são antecipados por este registro.
...
- Atuação com foco em cirurgias da face, sem usar títulos de especialidade que não correspondam ao registro formal.
- Planejamento individual, naturalidade e preservação de expressão e identidade.
- Consulta como espaço de avaliação e decisão informada, sem pressupor cirurgia.
- Clínica LIV Faria Lima, em Pinheiros, como sinal de estrutura, privacidade e conveniência — não como luxo vazio.

### 3.2 Espaços que não queremos ocupar

- Clínica popular, operadora de alto volume ou disputa por menor preço.
- Comunicação de luxo inacessível ou de cirurgiã-celebridade.
- Promessas de transformação, perfeição, resultado garantido ou ausência de cicatriz.
- Urgência comercial, promoção, desconto como argumento central ou pressão para decidir.
- Exploração de vergonha, envelhecimento, sofrimento corporal ou insegurança.
...
### 4.1 Perfil prioritário

- Pessoa em São Paulo ou com disponibilidade real para consulta presencial em Pinheiros.
- Já reconhece uma queixa ou pesquisa um procedimento específico.
- Valoriza formação médica, segurança, naturalidade, clareza e acompanhamento.
- Pode pagar uma consulta particular de R$ 500 e considera uma cirurgia particular de preço intermediário ou superior.
- Ainda pode ter objeção inicial de preço; isso não a torna automaticamente desqualificada.
- Quer compreender indicação, limites, recuperação, custos e próximos passos antes de decidir.

### 4.2 Perfil de menor prioridade

- Procura exclusiva por gratuidade, SUS, curso, emprego, solução caseira ou preço extremamente baixo.
- Busca apenas conteúdo acadêmico, imagens ou informação sem qualquer possibilidade de consulta.
- Procura procedimento ou atendimento que a clínica não oferece.
- Demonstra expectativa incompatível, promessa de perfeição ou pressão externa para operar.

### 4.3 Objeções reais observadas

- **Preço:** aparece explicitamente nas conversas e deve ser tratado com clareza, não evitado.
...
**Expansão secundária — mama e corpo:**

- cirurgias da mama, distinguindo as intenções relevantes em vez de tratá-las como um único produto;
- lipoaspiração;
- abdominoplastia.
...
- **Decisão vigente para Meta Ads:** campanhas faciais pagas devem usar controle efetivo de **40 anos ou mais**. Não reduzir esse piso nem permitir expansão etária automática. A tentativa de estender o conjunto histórico `M26F01W` foi descartada porque naquele objeto o `40–65+` era somente sugestão Advantage+, com `age_min=25`, e a edição ainda exigia Conta do WhatsApp Business e orçamento mínimo superior ao aprovado. Em 17 de agosto de 2026 foi preparada, sem publicação, uma nova campanha de **Tráfego → WhatsApp**, `M26F01W | Lifting facial SP | WhatsApp | 15 dias`, com São Paulo +20 km, controle rígido `40–65+`, todos os gêneros, orçamento total de R$ 300 e somente `C06H01`. O novo desenho substitui a exceção etária; a campanha histórica permanece encerrada e não será reativada.
- **Gate Meta WhatsApp 40+:** antes de publicar o novo `M26F01W`, confirmar no objeto final `age_min=40`, São Paulo +20 km, expansão geográfica desligada, somente WhatsApp como destino, R$ 300 total, janela de 15 dias e apenas o anúncio `120251254720680627`. O anúncio herdado de avaliação `120251254720710627` deve permanecer desligado. A publicação continua posterior ao release técnico e à sonda de atribuição. **Métrica:** distribuição real por idade; contatos válidos, qualificados e consultas por faixa quando mensuráveis. **Manter:** limite rígido 40+ sem perda material de qualidade/volume elegível. **Reverter:** somente por decisão estratégica explícita documentada neste Norte, nunca por recomendação automática da Meta.
...
Gerar consultas realizadas por pacientes compatíveis com a proposta da clínica e, depois, cirurgias com sustentabilidade econômica e adequação médica.

### 5.2 Hierarquia do funil

1. Visita ou clique de pesquisa com intenção compatível.
2. Contato válido pelo WhatsApp ou telefone.
3. Lead qualificado.
4. Consulta agendada.
5. Consulta realizada.
6. Cirurgia indicada e aceita.
7. Cirurgia realizada e receita associada.

### 5.3 Indicadores principais

- Custo por lead qualificado.
- Percentual de leads válidos classificados como qualificados.
- Percentual de qualificados que agendam.
- Custo por consulta agendada.
- Taxa de comparecimento.
- Percentual de consultas realizadas que evoluem para cirurgia.
- Custo por cirurgia e retorno financeiro, quando houver volume.

### 5.4 Indicadores de diagnóstico

- Termos de pesquisa e intenção observada.
- CTR, CPC e taxa de conversão da página.
- Parcela de impressões perdida por orçamento e por ranking.
- Desempenho por campanha, grupo, palavra-chave, dispositivo, região, dia e horário.
- Relevância do anúncio, experiência da página e CTR esperado.
- Taxa de correspondência da importação de GCLID, GBRAID e WBRAID.

CTR, CPC, força do anúncio e nota de otimização não são resultados finais do negócio.
...
- Em 15 de agosto de 2026 foi publicado em modo **default-off** um contrato first-party de jornada: `J0` no navegador, `J1` de transporte com resgate em até dez minutos, `J2` durável e claim `C1` HMAC com expiração absoluta de 30 dias. O desenho separa first touch, conversa atual e último toque não direto, não classifica ausência de referrer como acesso direto e remove click IDs do texto visível quando o modo rico está ativo. Daniel aceitou formalmente o risco residual de a linha técnica `JID` ser visível, editável e encaminhável antes do primeiro resgate, inclusive perda da atribuição se ela for removida e atribuição incorreta se um encaminhamento for resgatado primeiro. Em 17/08/2026, após autorização integral, o commit `436aff0` foi publicado, `attributionJourneyEnabled=true`, o schema v1 foi habilitado no deployment canônico v97 e a sonda sintética `synthetic_attribution_v2_20260817` concluiu com HTTP 200. A ativação entra em monitoramento; não é prova de desempenho real. **Métrica:** taxa de resolução/fallback, divergência LEADS–CRM, encaminhamento ou atribuição incorreta e perda de JID. **Revisão:** 24 horas, 7 dias e 14 dias após ativação. **Manter:** somente com zero PII, zero persistência indevida de JID, zero duplicidade e nenhuma atribuição incorreta comprovada. **Reverter:** desligar imediatamente a feature e voltar ao caminho legado diante de JID persistido fora do resolvedor, encaminhamento atribuído à pessoa errada, first touch sobrescrito, duplicidade ou regressão de atendimento.

### 6.3 Orçamento

O orçamento total informado para Google Ads é de aproximadamente **R$ 2.800 por mês**. Esse valor é a referência operacional atual, não um teto estratégico.
...
**Decisão vigente e estado publicado:** manter duas campanhas secundárias de Pesquisa até 12/10/2026, preservando face como foco principal. `S_BR_SP_CIRURGIA_MAMA` (`G26MAMA`, ID `24239348529`) e `S_BR_SP_CONTORNO_CORPORAL` (`G26CORP`, ID `24239348532`) estão ativas e qualificadas em aprendizado com R$ 8/dia cada. Ambas usam somente Rede de Pesquisa Google, português, cidade de São Paulo por presença física, todas as idades incluindo `Desconhecida`, todos os dispositivos, parceiros e Display desligados, Maximizar cliques e a meta personalizada `Lead qualificado GCLID — campanhas`. Não ativar Performance Max, correspondência ampla, expansão automática, tCPA ou conversões otimizadas para leads.

**Estrutura e destinos:** manter intenção de procedimento em `AG_MASTOPEXIA` → `/mastopexia/`, `AG_MAMOPLASTIA_REDUTORA` → `/mamoplastia-redutora/`, `AG_PROTESE_MAMA` → `/protese-de-mama/`, `AG_ABDOMINOPLASTIA` → `/abdominoplastia/` e `AG_LIPOASPIRACAO` → `/lipoaspiracao/`. Para preço, `AG_MASTOPEXIA_PRECO` e `AG_PROTESE_MAMA_PRECO` apontam para `/conteudos/quanto-custa-cirurgia-plastica-mama-sao-paulo/`, enquanto `AG_LIPOASPIRACAO_PRECO` aponta para `/conteudos/quanto-custa-cirurgia-plastica-corporal-sao-paulo/`. Os três grupos específicos, seus RSAs e as oito palavras foram publicados e relidos antes da pausa reversível, sem exclusão, de `AG_CIRURGIA_MAMA_PRECO` e `AG_CONTORNO_CORPORAL_PRECO`. A divisão por procedimento mantém cada RSA coerente com suas palavras e permite leitura precisa do funil; os dois grupos genéricos permanecem somente como aliases históricos.

**Comunicação das páginas de destino:** os dois guias já apresentam resposta direta à busca de preço, distinguem os procedimentos, explicam equipe, anestesia, hospital, materiais, consulta, pagamento e orçamento individual e oferecem CTA para avaliação. Preservar essa comunicação no primeiro ciclo para isolar o efeito do roteamento. Não criar páginas clonadas, publicar faixa cirúrgica ou trocar simultaneamente CTA/texto sem evidência por grupo e landing.

**Qualidade e relevância dos anúncios:** a releitura viva de 12/09 encontrou `AG_MASTOPEXIA` e `AG_ABDOMINOPLASTIA` como `Ruim`, ambos sem impressão, clique ou gasto. Os dois RSAs foram corrigidos antes da primeira entrega: mastopexia passou a usar naturalmente `lifting mamário`; abdominoplastia, `excesso de pele no abdômen` e `cirurgia de contorno abdominal`. A releitura após o upload mostrou ambos como `Excelente`. Os três novos RSAs de preço repetem as expressões específicas de seu próprio grupo e ficaram `Qualificados`, ainda sujeitos à revisão normal de política. URL, caminhos, atribuição, promessa médica e ausência de faixa cirúrgica foram preservados. A força exibida pelo Google continua sendo diagnóstico, não objetivo de negócio.
...
**Mensuração:** `{_camp}` mantém `G26MAMA` ou `G26CORP`; o registro reconhece dez códigos secundários. `ag_cirurgia_mama_preco` e `ag_contorno_corporal_preco` ficam legíveis para preservar o intervalo da v148, sem inventar procedimento, mas seus grupos não recebem tráfego novo. Na v149, `ag_mastopexia_preco`, `ag_protese_mama_preco` e `ag_lipoaspiracao_preco` preservam procedimento, intenção e landing nos três grupos específicos ativos. Marcação automática e `GCLID`/`GBRAID`/`WBRAID` permanecem intactos. Lead qualificado só entra na importação padrão com manifestação pessoal, fase canônica e exatamente um click ID elegível; clique, prefill e pergunta inicial de preço isolada não são conversão de negócio. O consumidor Netlify que antecipa o contexto do procedimento pelos sufixos `_preco` foi publicado no commit `64ae2c598816c033b4e2a995d064adddf80de54a`, deploy `6aa5e56c65ed3d0008cebf97`, e permaneceu no descendente atualmente em produção. Domínio e URLs imutáveis responderam com o mesmo estado de saúde; ausência ou conflito de contexto continua sem autorizar inferência nem conversão.

**Hipótese e decisão:** separar preço de procedimento antes das primeiras impressões cria um baseline limpo e melhora a continuidade entre termo, anúncio e página sem elevar orçamento. A evidência histórica do lifting facial — muito clique no grupo de preço e pouco downstream — impede presumir que preço converterá melhor; o teste existe para medir, não para validar uma conclusão prévia. Conferir em 24 horas elegibilidade, URLs, gasto e atribuição; em D+7 e D+14, termos, contatos válidos, qualificados e consultas por grupo/landing; em D+30, decidir manter, redistribuir internamente ou pausar. Pausar imediatamente somente o componente afetado por destino incorreto, política, gasto anormal, perda de códigos/click ID, PII, falsa atribuição ou regressão do atendimento. Com tracking saudável, revisar uma campanha ao atingir R$ 120 sem contato válido e não escalar nenhuma antes de pelo menos dois qualificados e uma consulta agendada. CTR, CPC e força do anúncio são diagnósticos, não critério isolado.

**Recibo de ativação:** uploads de campanhas `8304615862134805016`, grupos `1035226498139761048`, palavras conformes `4941378120393558080`, RSAs `6913781089229317932`, sitelinks `1668147931032527165` e ativação `5196337282830450399`, todos aplicados sem erro. Cinco grupos, 13 palavras exatas/frase, cinco RSAs e 20 sitelinks ficaram ativos; políticas e aprendizado ainda podem mudar o estado individual de cada entidade. A prévia inicial encontrou termos bloqueados por política de saúde, que foram removidos sem pedido de exceção. O refinamento de preço foi aplicado sem erro pelos uploads `27885666172234525` (três grupos), `8370800241093983490` (três RSAs), `776172141302390487` (oito palavras), `8536118842992338984` (dois RSAs corrigidos) e `3397105701539708642` (pausa dos dois grupos genéricos). A mensuração está materializada na v149 do Apps Script; a importação qualificada continua reconciliada por `Opportunity ID` e separada do diagnóstico de clique ou força do anúncio.
...
### 6.5 Ciclo Meta de lifting facial e lifting cervical — decisão de 16 de agosto de 2026

Daniel autorizou a preparação do ciclo em 16/08/2026 e a publicação integral em 17/08/2026. O pacote técnico, o schema v1 e a sonda foram concluídos antes da publicação seletiva das três campanhas; o início programado permanece 17/08/2026 às 12h.
...
- **Decisão publicada:** manter `M26F01W` somente com `C06H01` e destino WhatsApp; não renovar `M26F02S`; interromper `M26O01W`; e restringir o experimento de destino ao lifting cervical em dois braços: `M26C01W` — WhatsApp direto — e `M26C02S` — site → WhatsApp. As três campanhas de Tráfego foram publicadas seletivamente em 17/08/2026, cada uma com São Paulo +20 km, limite rígido 40–65+, todos os gêneros, orçamento total de R$ 300 e janela de 17/08/2026 às 12h a 01/09/2026 às 12h. Os dois braços cervicais usam `C07H01`, arquivo 1:1 no Feed e arquivo 9:16 próprio em Reels/Stories. O facial usa apenas `C06H01`, também em 1:1 e 9:16. A rota determina a meta operacional de entrega — conversas no braço direto e LPV no Site —, por isso a comparação cervical mede qual sistema completo produz mais resultados de negócio e não causalidade pura do clique. `M26F01W/C06H01` corre em paralelo e é analisada separadamente; não é um terceiro braço nem um controle causal do cervical.
- **Decisão do criativo:** os arquivos finais corrigem `cervecoplastia` para `cervicoplastia`. O áudio e a legenda embutida permanecem com `Clique no link da bio`; Daniel aceitou formalmente esse risco em 16/08/2026. O quadrado será usado apenas no Feed; o 9:16 de 1080×1920, já enviado ao Ads Manager, ocupará Reels/Stories sem recorte automático do quadrado. O Reels orgânico será publicado em 20/08/2026 às 19h30, identificado separadamente e não reutilizado como publicação do anúncio; tráfego orgânico não entra na comparação paga.
- **Gate de atribuição:** `age_min=40` observado nos dois braços cervicais e no novo facial; `M26C01W-C07H01`, `M26C02S-C07H01` e `M26F01W-C06H01` preservados; `M26C02S` entra em `/lifting-cervical/` com UTMs canônicas; modo rico, schema, privacidade, purge e migração passam pelos gates próprios; sonda sintética sem paciente comprova Meta → site → navegação → CTA → WhatsApp → webhook → LEADS → CRM, com campanha, criativo, landing, página do CTA, caminho, confiança e first touch corretos; campanhas reconhecidas pelo agregado/rotina; Meta Ad IDs `120251248762170627`, `120251249058760627` e `120251254720680627` mapeados; baseline e rollback salvos. Se qualquer gate falhar, adiar os dois braços cervicais; falha isolada no facial adia somente `M26F01W`.
- **Orçamento:** o teste cervical soma R$ 600 em 15 dias, R$ 300 por braço. A continuidade de lifting facial adiciona R$ 300, levando o pacote autorizado e publicado a R$ 900. Qualquer valor superior exige nova autorização.
- **Reconstrução etária do lifting facial:** a extensão do objeto histórico de `M26F01W` foi descartada. A nova campanha `120251254720690627`, conjunto `120251254720700627` e anúncio principal `120251254720680627` foram publicados; o anúncio herdado `120251254720710627` permaneceu desligado. A prévia confirmou controle rígido `40–65+` e São Paulo +20 km; a entrega etária real será conferida no primeiro relatório pós-início.
- **Métrica:** contatos identificados, válidos, qualificados, agendados e realizados; custo por qualificado e por agendamento; cobertura conversa → contato; CTR/CPC/conversa apenas como diagnóstico. Lifting facial é acompanhado em série própria e não decide a rota cervical.
...
### 6.6 Piloto OOH hiperlocal — Aqui Ads

O Aqui Ads entra no plano como teste complementar de construção de familiaridade local, não como substituto de Google Pesquisa ou Meta e não como canal de resposta direta presumida. A decisão está agendada para **16 de setembro de 2026**; nenhuma compra ou veiculação foi autorizada por este registro.

- **Público e inventário:** priorizar ambientes frequentados por pessoas de maior poder aquisitivo, especialmente 40+: dois edifícios residenciais premium e um salão/spa premium em Jardim Europa, Itaim Bibi, Vila Nova Conceição, Alto de Pinheiros ou Pinheiros. Edifícios comerciais da Faria Lima ficam para uma segunda etapa, pois misturam mais perfis e jornadas.
- **Investimento:** envelope indicativo de **R$ 1.206,20 por quatro semanas**, antes da produção da peça, com base em simulações consultadas em 16/08. Preço, disponibilidade e metodologia de audiência devem ser revalidados no gate. A verba é incremental e não pode reduzir os orçamentos atuais de Google ou Meta.
- **Hipótese:** repetição em locais premium próximos à área de atendimento aumenta lembrança e confiança na Dra. Amanda e contribui para contatos qualificados e consultas, ainda que a resposta possa ocorrer depois por busca de marca, acesso direto ou indicação.
- **Criativo:** institucional e sóbrio, com Amanda como protagonista, naturalidade, planejamento e localização; uma chamada de baixa pressão. Sem preço, promoção, garantias, vergonha ou antes/depois. Identificação profissional e compliance precisam passar pelo gate aplicável antes da compra.
- **Métrica principal:** contatos válidos, qualificados e consultas agendadas atribuídos ao piloto. Busca de marca, acesso direto, Perfil da Empresa, QR/landing/WhatsApp exclusivos e `Como conheceu?` são sinais de apoio; impressões, alcance e frequência informados pela plataforma não são resultado de negócio e só podem ser usados depois de entender sua metodologia.
- **Gates:** tracking exclusivo registrado no catálogo canônico, cobertura esperada ≥80%, capacidade confirmada, orçamento incremental autorizado e nenhuma mudança material concorrente em Google, Meta ou atribuição. A ativação ocorre na primeira janela limpa após 16/09, não automaticamente na data do gate.
- **Regra de decisão:** revisar em D+7, D+14, D+28 e D+35. Cobertura <80% torna o resultado inconclusivo e impede escala. Não renovar com zero qualificado atribuído, tracking saudável e ausência de sinal coerente de marca. Renovar ou ampliar somente com evidência de negócio, teto de custo aprovado e nova autorização explícita.

## 7. Estratégia de Google Ads

### 7.1 Prioridade de canal

Enquanto a mensuração offline e o volume de conversões qualificadas não estiverem suficientemente estáveis, a prioridade paga é **Google Pesquisa**. Performance Max, Demand Gen ou expansão automatizada não devem ser adotadas apenas para obter mais volume.

Busca orgânica, presença local e descoberta em buscadores com IA devem ser desenvolvidas de forma complementar, com conteúdo útil, identidade verificável e arquitetura coerente. Elas não substituem a mensuração do funil nem justificam páginas genéricas criadas apenas para ampliar cobertura.

### 7.2 Estrutura das campanhas

- Um procedimento ou intenção principal por campanha.
- Grupos pequenos e temáticos dentro de cada campanha.
- Correspondência de frase ou exata como ponto de partida para temas de maior controle.
- Correspondência ampla somente como teste consciente, com conversão confiável, negativas e regra de avaliação definida.
- Página de destino específica e coerente com o termo e o anúncio.
- Campanha de marca separada das campanhas de procedimento.
- Intenção informativa, preço e consulta não devem ser misturadas indiscriminadamente.

### 7.3 Campanhas conhecidas e códigos

| Campanha | Código estável | Papel |
|---|---|---|
...
Os nove grupos anteriores e sete grupos secundários estão publicados; os dois grupos genéricos de preço serão mantidos como aliases históricos depois de pausados. Os três grupos específicos candidatos deixam oito grupos secundários ativos e dez códigos legíveis somente após o recibo vivo. O mapa operacional completo fica em `campanhas/GUIA-LINGUAGEM-TRAFEGO-PAGO.md`; a prova de valor resolvido no clique, no site, no WhatsApp, em LEADS e no CRM continua sendo gate separado.
...
### 7.4 Linguagem dos anúncios

Os anúncios devem combinar:

- problema ou intenção reconhecível;
- avaliação médica;
- naturalidade ou preservação da identidade;
- localização quando útil;
- próximo passo claro e não agressivo.

Linhas prioritárias para testes:

1. **Técnica e segurança:** avaliação individual, formação, limites, recuperação e planejamento.
2. **Naturalidade:** tratar a causa sem apagar expressão ou identidade.
3. **Proximidade:** atendimento e acompanhamento direto da médica.
4. **Decisão sem pressão:** consulta para entender possibilidades, inclusive a possibilidade de não operar naquele momento.

Não usar “a melhor”, “resultado garantido”, “sem cicatriz”, “corpo perfeito”, vergonha corporal ou perguntas que afirmem um atributo físico de quem vê o anúncio.

### 7.5 Termos de preço

Pessoas que pesquisam preço não devem ser excluídas automaticamente. Preço pode ser a primeira linguagem usada por uma paciente ainda capaz de valorizar segurança, atendimento e naturalidade.

A estratégia é:

- medir separadamente os termos de preço;
- avaliar se eles produzem leads qualificados e consultas, não apenas cliques;
- levar a uma página que explique os componentes do custo, os fatores que individualizam o planejamento e como o orçamento é definido depois da avaliação, sem publicar faixa numérica de cirurgia; no guia específico de lifting, a página pode informar que uma faixa geral está disponível em conversa individual pelo WhatsApp, sem antecipar números e sem apresentá-la como orçamento, proposta ou garantia;
...
> Manter várias portas de entrada para busca, mas apenas um caminho principal de conversão em cada página.

Cada página comercial deve:

1. reconhecer a intenção que trouxe a pessoa;
2. dar uma resposta curta;
3. apresentar prova e confiança pertinentes;
4. explicar como funciona a avaliação e a decisão;
5. informar os aspectos práticos da consulta;
6. oferecer o CTA `Ver horários da consulta`;
7. deixar conteúdos profundos e relacionados depois do caminho principal.

O clique abre o WhatsApp e não deve fingir que o agendamento já foi concluído.
...
O mesmo conteúdo deve servir pessoas e mecanismos de descoberta sem sacrificar clareza clínica ou conversão. A arquitetura deve:

- permitir rastreamento e indexação das páginas públicas relevantes;
- preservar sitemap, canonicals, redirecionamentos, status HTTP e links internos coerentes;
- declarar com precisão autoria, formação, CRM, RQE, localização, procedimentos e data de atualização;
- usar dados estruturados válidos quando representarem fatos visíveis na página;
- responder perguntas reais de forma direta, específica e atribuível;
- separar intenções que precisam de respostas próprias sem produzir páginas quase duplicadas;
- permitir o `OAI-SearchBot` quando a decisão for aparecer na busca do ChatGPT, independentemente da política adotada para o `GPTBot`;
- manter consistência entre site, Perfil da Empresa no Google e outras fontes públicas controladas pela clínica.

Não existe garantia de posição, citação ou recomendação no Google, no ChatGPT ou em outro buscador. Tráfego orgânico, impressões e citações são sinais de descoberta; o valor deve ser avaliado também pela qualidade dos contatos, consultas e cirurgias que produzirem.

## 9. Continuação no WhatsApp

A Bruna atua como assistente ou concierge da Clínica LIV Faria Lima; a apresentação padrão permanece `concierge da Clínica LIV Faria Lima`. Ela continua a intenção iniciada no anúncio e na página sem explicar tecnologia ao paciente.

O fluxo esperado é:

1. responder primeiro à pergunta real;
2. reconhecer procedimento ou contexto quando conhecido;
3. identificar o estágio da decisão;
4. trabalhar uma objeção por vez;
5. explicar a consulta como próximo passo quando houver prontidão;
6. buscar preferência de agenda e encaminhar opções reais para revisão humana.
...
Antes de qualquer envio automático, o sistema deve reconstruir até as últimas 32 interações em ordem, preservando paciente, Bruna e equipe humana, e confrontar a resposta planejada com a mensagem atual. A IA é a primeira instância para compreender o significado do turno elegível. Pontuação, palavras-chave, códigos, templates e classificações são pistas; ausência de interrogação ou construção coloquial não pode, sozinha, produzir silêncio. Uma resposta curta deve ser interpretada como continuação da pergunta anterior quando houver esse contexto. Se a paciente apenas responder ou confirmar uma pergunta feita pela equipe humana, a IA pode concluir pelo silêncio; se houver nova dúvida contextual, mesmo sem formato mecânico de pergunta, ela pode responder dentro das travas. A validação final bloqueia respostas que reiniciem a conversa, repitam o que já foi tratado ou atravessem o atendimento humano.
...
**Decisão de 18/08/2026 — compreensão semântica antes do padrão mecânico:** aplicar esse princípio a respostas livres, coordenação depois de tomada humana e também à escolha de cópias determinísticas. Se a IA não conseguir distinguir com segurança entre interpretações que mudariam a resposta, deve fazer uma única pergunta curta e específica; ambiguidade clínica ou operacional reservada continua humana. A cópia determinística só substitui a redação da IA quando código, procedimento e profissional forem compatíveis e a prévia resolver todos os pedidos seguros do turno. Depois de fala da equipe, uma autorização semântica genérica não atravessa o takeover: somente reabertura, esclarecimento, coordenação ou cópia institucional explicitamente confirmados podem responder. A evidência inicial foi uma pergunta coloquial sobre disponibilidade de cervicoplastia que o roteamento reconheceu como procedimento conhecido, mas silenciou porque o detector mecânico não encontrou `?`. A hipótese é reduzir silêncios incorretos e manter continuidade sem aumentar respostas fora de contexto. Medir taxa de resposta elegível, resolução contextual, pedidos de esclarecimento úteis, competição com humano e incidentes de segurança. Revisar as próximas entradas reais e os cenários sintéticos semanalmente; manter se o silêncio incorreto cair sem piora dos guardrails e reverter se houver resposta insegura, intrusão em takeover ou aumento recorrente de esclarecimentos desnecessários.

**Decisão publicada de 26/08/2026 — preferência humana mínima de dez minutos:** depois de qualquer saída humana, nenhuma entrada da paciente recebe resposta imediata da Bruna. A mensagem concreta mais recente inicia uma janela mínima de dez minutos; nova entrada reinicia o prazo e nova saída humana cancela a pendência. Na execução, o sistema relê os 20 turnos atuais e pode responder uma nova pergunta segura e autônoma sem exigir que a fala humana anterior contenha um convite ou uma frase específica. Agenda e confirmação final, urgência e cuidado clínico, preço sem contrato aprovado, promessa humana, opt-out, encerramento, adiamento, mensagem mais recente e duplicidade continuam dominantes. **Motivo e evidência:** uma pergunta objetiva sobre valor ficou sem continuidade automática apenas porque veio depois de uma intervenção humana cujo texto não correspondia ao padrão estreito de oferta; ao mesmo tempo, a equipe precisa ter prioridade real para continuar a conversa. **Hipótese:** a espera de dez a quinze minutos reduz competição com a equipe e recupera dúvidas seguras que, de outro modo, ficariam sem resposta. **Métricas:** respostas automáticas após takeover, tempo entre entrada e resposta, cancelamentos por nova fala humana, silêncios incorretos, duplicidade, alertas e incidentes de segurança. **Revisão:** primeiras conversas elegíveis e consolidação em 02/09/2026. **Manter:** zero intrusão antes de dez minutos, zero envio depois de nova fala humana e redução de perguntas seguras sem resposta. **Reverter:** qualquer resposta antes do prazo, competição com humano, duplicidade, procedimento ou preço incorreto, ou quebra de proteção clínica/operacional. A mudança não altera Google Ads, Meta, orçamento, lance, campanha, site, Apps Script, LEADS ou CRM.

**Extensão candidata de 12/09/2026 — cooperação entre Bruna e equipe, ainda sem publicação:** A conversa compartilhada passa a usar a entrada mais recente e uma janela protegida de dez minutos, processada a cada cinco minutos. Antes de responder, relê histórico, compromissos e preferências; nova atividade humana ou da paciente invalida a tentativa, inclusive depois de reservar o envio. Dúvida segura pode ter uma resposta pontual, mantendo qualquer tarefa humana anterior. Solicitação que depende da equipe recebe no máximo uma confirmação de recebimento por geração, somente após entrega do alerta; não promete horário ou resultado. Alertas de novas mensagens são consolidados por trinta minutos, com exceção de urgência, e falhas continuam recuperáveis. Agradecimento, encerramento e ciência de compromisso humano não criam trabalho artificial. O aviso de recebimento mantém a LEADS aguardando a clínica. Motivo: reduzir sobreposição e a carga de acompanhamento humano sem pressionar uma decisão cirúrgica. Evidência: auditoria de autoria em 302 mensagens e regressões sintéticas de concorrência, perda de alerta e responsabilidade. Hipótese: menor espera sem resposta e menos tarefas repetitivas, com preservação de consulta qualificada e autonomia. Métricas: respostas sobrepostas, avisos repetidos, entrega de alertas, tempo até resposta útil, pendências reais da clínica e consultas por origem. Revisão: primeiro ciclo, 24h, 48h e D+7 após publicação aprovada. Manter se reduzir pendências sem perda de segurança; conter ou reverter diante de sobreposição, orientação clínica indevida, opt-out ignorado, aviso sem alerta entregue ou tarefa humana apagada. Registro técnico e evidência em `auditorias/bruna-conversao-leads-2026-09-12/RELATORIO.md`.

**Decisão local candidata de 23/08/2026 — economia sem perder a releitura de contexto:** a primeira retomada comercial continua sujeita ao veto semântico imediatamente antes do envio. Na segunda e última retomada, uma nova chamada de IA pode ser dispensada somente quando a mensagem foi aprovada pela equipe, a primeira tentativa ocorreu depois da entrada comprovada do veto em produção, a última interação durável ainda é exatamente aquela retomada automática e não houve qualquer fala posterior da paciente ou da equipe. Preferência de contato, janela, estágio, procedimento, conteúdo sensível, agenda, preço, promessa humana e mensagem mais recente continuam revalidados deterministicamente. Qualquer edição de contexto, nova entrada ou saída, âncora não automática ou evidência incompleta devolve o caso à revisão semântica fail-closed. **Hipótese:** reduzir uma chamada de IA nas sequências silenciosas sem aumentar envios fora de contexto. **Métricas:** proporção de segundas retomadas com revisão reutilizada, economia estimada de chamadas, respostas posteriores, cancelamentos por mudança de contexto e incidentes. **Gate de publicação:** testes focados e integrais aprovados, commit delimitado, autorização explícita, mesmos deployments canônicos e pós-voo sem mensagem real.

**Decisão publicada e verificada em 12/09/2026 — primeira retomada por modelo após 24 horas, ainda desligada:** o commit aprovado `3d022332a6f1f2dbd7729c45c3083b1696172812` está no deployment Apps Script canônico v142 e no Netlify `6aa536c2f301b80008efe5e6`, sem ativação. A leitura operacional sem PII encontrou seis retomadas de marketing visíveis, todas manuais; cinco estavam elegíveis apenas para aprovação humana por modelo e uma não tinha mensagem segura. No histórico da fila, 42 planos automáticos foram cancelados por fechamento da janela do WhatsApp, enquanto o último envio automático ocorreu em 30/08 e a última tentativa em 01/09. O conflito estrutural é que a cadência comercial espera cerca de 24 horas, mas o texto livre depende da janela de atendimento da última entrada; fora dela, o modelo existente exigia aprovação humana. **Mudança publicada default-off:** permitir, somente depois de ativação específica, uma primeira retomada por modelo aprovado entre 24 e 48 horas para a conversa de menor risco: exatamente o prefill genérico de procedimento conhecido seguido de uma pergunta da Bruna ainda sem resposta. Apps Script e endpoint repetem o mesmo gate; preço, agenda, clínica, imagem, exame, risco, urgência, terceiro turno, takeover, opt-out, pausa, promessa humana e procedimento divergente permanecem bloqueados. Duas flags independentes, preflight autenticado, data de ativação e marcador por plano impedem publicação acidental e backlog. A segunda retomada e o pós-consulta permanecem humanos. Os arquivos vivos e o deploy foram relidos, as flags continuaram ausentes, a sonda inválida não aplicou decisão e nenhuma função operacional, trigger, fila ou mensagem real foi executado. **Hipótese:** recuperar continuidade em contatos simples que hoje viram tarefa manual sem aumentar pressão ou mensagem fora de contexto. **Métrica principal:** planos elegíveis, programados, enviados, respondidos e convertidos em contato válido, qualificado e consulta; motivos de bloqueio, opt-outs e incidentes são guardrails. **Revisão:** primeiro plano elegível, 24 horas, 72 horas e 7 dias depois de uma eventual ativação. **Regra para manter:** zero envio anterior à ativação, antes de 24h, depois de 48h, após nova atividade ou em contexto protegido, com resposta ou avanço downstream suficiente para justificar o caminho. **Regra para reverter:** desligar primeiro a flag do Apps Script e depois a do endpoint diante de qualquer envio indevido, duplicidade, procedimento incorreto, competição humana, opt-out, falha de template ou ausência de rastreabilidade; não reverter por volume baixo isolado.

**Decisão local candidata de 12/09/2026 — medir a jornada por decisão e profissional, sem alterar mídia:** o candidato `EVOLUCAO-BRUNA-JORNADA-2026-09-12` acrescenta ao ledger operacional códigos de `Decision ID`, `Opportunity ID`, profissional, relação, etapa, rota, motivo, versões, gate, latência e responsável pela revisão. Amanda, Daniel e profissionais eventuais permanecem separados; ausência de profissional nunca herda Amanda. Nenhum texto, nome, telefone ou dado clínico entra nessa telemetria. **Hipótese:** unir a decisão conversacional ao grão da oportunidade permitirá distinguir campanha que apenas abre conversa de campanha que produz contato válido, qualificação, consulta, comparecimento e cirurgia, além de localizar silêncios, handoffs e bloqueios que interrompem a jornada. **Métricas:** cobertura dos IDs, motivos de rota, tempo até resposta/handoff, contato válido, qualificado, consulta agendada/realizada, comparecimento e resultado por campanha e profissional; cliques, LPV e abertura do WhatsApp permanecem diagnóstico. **Gate futuro:** somente publicar após preflight vivo de esquema, profissional e Calendar, testes integrais e autorização explícita; manter se a cobertura aumentar sem PII, atribuição indevida ou competição humana; conter diante de qualquer mistura de profissional, duplicidade, dado pessoal no ledger ou divergência de agenda. Esta decisão não altera campanha, orçamento, lance, público, anúncio, página, flag, planilha ou Calendar nesta etapa local.

**Extensão integrada de 12/09/2026 — custo por mensagem entregue, em observação:** o candidato passa a se chamar `EVOLUCAO-BRUNA-JORNADA-YCLOUD-2026-09-12` e registra uma única vez o estado final, categoria, moeda e `totalPrice` que a YCloud informar para cada mensagem entregue, usando somente chaves opacas e sem telefone, nome, texto ou identificador bruto. O aceite do envio não é contado como entrega. A mudança de preço anunciada para 01/10/2026, inclusive utility dentro de 24 horas, será medida pela fatura/evento real do provedor; a franquia de 1.000 mensagens de serviço por número e mês é referência de diagnóstico, não estimativa que autoriza gasto. **Hipótese:** somar mensageria ao funil por `Opportunity ID`, campanha e profissional permitirá avaliar custo por contato válido, qualificado e consulta sem cortar continuidade clínica. **Métricas:** entregas únicas, preço final ausente, custo por categoria/finalidade, custo por contato válido, qualificado, agendado e realizado, opt-out e incidentes. **Regra inicial:** observar sem teto automático; nunca bloquear acolhimento, segurança, handoff, lembrete ou pós-cuidado. Retomada comercial só poderá receber limite futuro por decisão separada, com amostra real e autorização explícita. Esta extensão não altera campanha, orçamento, lance, público, anúncio ou página.

**Ajuste publicado de 20/08/2026 — cobertura semântica também antes da rota:** a ausência de oportunidade ou o estado `route_pending` não impede que uma mensagem legível seja compreendida. Depois do registro idempotente, o sistema recupera até 32 turnos duráveis, incluindo falas humanas disponíveis, e solicita à IA contexto, profissional, procedimento, tipo de ação, confiança e sugestão. Alta confiança pode recuperar Amanda ou Daniel somente no modo ativo; ambiguidade segura recebe uma única pergunta; decisão sem autorização permanece em revisão humana; e casos humanos recebem uma sugestão interna apenas quando ela puder ser escrita sem inventar fatos. `Shadow` não envia nem altera a rota ou a agenda; `off` preserva a entrada para a equipe e bloqueia IA, resposta, agenda e disparos programados. Duplicidade, opt-out, urgência, cuidado ativo, agenda não validada, mensagem mais recente e takeover continuam dominantes. **Hipótese:** eliminar a lacuna entre mensagem registrada e oportunidade criada reduz silêncios incorretos e melhora a continuidade sem aumentar respostas fora de contexto. **Métricas:** cobertura semântica entre textos elegíveis, `route_pending` recuperados, esclarecimentos úteis, tempo de primeira resposta, sugestões internas utilizáveis, duplicidade, intrusão humana e incidentes de segurança. **Validação e publicação:** **912/912 testes**, build de 178 arquivos e 44 URLs sem erro; commit funcional `afa230263288bba88fb0cb61f4fb55e5903d4dca`, deploy Netlify `6a8701bb1ae7b60008c3a8ac` e Apps Script v106. **Revisão:** primeiras entradas reais e leitura em sete dias. **Manter:** queda de silêncio com zero quebra de guardrail. **Reverter:** qualquer roteamento profissional incorreto recorrente, resposta clínica indevida, competição com humano ou aumento material de latência sem ganho operacional. Este ajuste altera somente o atendimento e não muda Google Ads, Meta, orçamento, lance, campanha ou página.

**Decisão de 19/08/2026 — prefill neutro e intenção pessoal para avanço:** links do site usam a abertura `Olá! Tenho interesse em [procedimento] com a Dra. Amanda e gostaria de entender melhor como funciona a avaliação.` e carregam `template_id=procedure_evaluation_v1`. Somente esse identificador estruturado marca a mensagem automática; frases, referências e origem não bastam. Prefill isolado é contexto, não qualifica, não gera conversão offline, não encaminha agenda e não prova prontidão. A Bruna responde perguntando o que a pessoa deseja entender primeiro. Dias e período só entram após pedido pessoal de agendamento, aceite explícito de consulta à agenda ou preferência informada. Perfil de empresa ou marca não recebe personalização nominal. **Hipótese:** uma abertura neutra reduz avanço prematuro e preserva resposta em otoplastia, lipo e lifting. **Métrica:** resposta elegível, continuidade após a primeira resposta, qualificação com evidência pessoal, entrada em agenda e conversão offline válidas; monitorar silêncios, saltos indevidos para agenda e nomes comerciais usados como pessoa. **Revisão:** próximos contatos reais e regressões semanais. **Manter:** zero qualificação/agenda/conversão por prefill isolado e continuidade natural. **Reverter:** perda recorrente de resposta elegível ou bloqueio de intenção pessoal clara. Publicação técnica e alterações das mensagens salvas nas plataformas exigem release autorizado e verificação ponta a ponta.

**Decisão de 19/08/2026 — cervicoplastia como ponte de linguagem para lifting cervical:** usar `cervicoplastia (lifting cervical)` na entrada da página cervical, nos metadados, na dúvida de equivalência, no prefill estruturado e na primeira resposta da Bruna. Preservar a URL `/lifting-cervical/`, reconhecer os dois termos como o mesmo contexto de procura e manter técnica, extensão e indicação individualizadas. A evidência qualitativa é a repetição de `cervicoplastia` na linguagem espontânea de pacientes; a evidência de conta já registrada mostra `"cervicoplastia"` e `[cervicoplastia]` em `AG_CERVICOPLASTIA`, portanto não criar palavras-chave duplicadas, não mudar orçamento, lance, grupos ou campanha nesta etapa. **Hipótese:** alinhar a linguagem entre busca, página e WhatsApp reduz dúvida terminológica e melhora continuidade sem ampliar promessa clínica. **Métrica:** contatos cervicais válidos, continuidade após a primeira resposta, qualificados e consultas; acompanhar termos de pesquisa, CTR e eventual confusão com lipo de papada na próxima leitura autenticada. **Revisão:** 7 e 14 dias após publicação, condicionada a volume suficiente. **Manter:** melhor compreensão e continuidade sem perda de qualidade. **Reverter:** aumento consistente de tráfego não aderente, confusão de indicação ou piora material de qualificação. Um teste de texto de anúncio só deve ser proposto após verificar o RSA vivo e ter base comparável; esta decisão não autoriza mutação no Google Ads.

Para lead qualificado:

- resposta idealmente em menos de cinco minutos;
- reconhecimento da objeção principal;
- próximo passo claro;
- duas opções reais de horário depois da validação humana necessária;
- primeira retomada em aproximadamente 24 horas, ligada à objeção específica;
- segunda e última retomada em aproximadamente 72 horas, com prova pertinente;
- encerramento das retomadas depois de duas tentativas ou de uma recusa clara.

## 10. Estratégia de preço
...
### 11.1 Hierarquia desejada de conversões

- **Principal para otimização quando tecnicamente validada:** lead qualificado com identificador de clique correspondente.
- **Resultados de negócio a importar progressivamente:** consulta agendada, consulta realizada e cirurgia.
- **Secundárias para observação:** clique no WhatsApp, clique no telefone e início de formulário.
...
Se o volume de leads qualificados for insuficiente para lances automáticos, uma ação intermediária só poderá ser usada provisoriamente quando tiver correlação demonstrável com qualificação. Ela não deve ser escolhida apenas porque produz mais eventos.

### 11.2 Regras de lances

- Não migrar automaticamente para Maximizar conversões ou CPA desejado antes de validar a conversão usada.
- A sugestão automática anterior de CPA desejado de R$ 134,41 não foi aceita porque ainda era necessário saber qual conversão e qual histórico sustentavam o número.
...
- **Em todo e-mail efetivamente enviado, inclusive alerta diário:** apresentar métricas essenciais de 7 e 30 dias por campanha — gasto, alcance, frequência, cliques e CTR link, LPV, conversas e resultado principal da plataforma — e o funil anônimo de contatos, qualificados, agendados, realizados e fechamentos. O e-mail diário continua condicionado a alerta novo, piora ou persistência após 48 horas; ausência de e-mail não significa ausência de coleta.
...
A rotina mantém `M26F01W/C06H01` como referência operacional contínua do lifting facial no WhatsApp, `M26F02S` sem verba nova e Meta facial em 40+. O teste Site × WhatsApp de cervical é avaliado somente entre `M26C01W` e `M26C02S`; lifting facial não é terceiro braço. Fadiga criativa só pode ser sugerida por sinais combinados e amostra mínima; frequência isolada não autoriza troca. Resultado de plataforma não é paciente. CAPI, coleta adicional ou recomendação da Meta nunca são ativados automaticamente. O token permanece somente nas propriedades protegidas do projeto e o agregado/e-mail não contém PII nem IDs de paciente.
...
- Comparar custo por lead qualificado e passagem para consulta.
- Examinar perda de impressões por orçamento e por ranking.
- Revisar anúncios e páginas dos grupos com gasto relevante.
- Separar falta de volume de falha de mensuração.
- Decidir manter, pausar, corrigir ou escalar com base em regra escrita.

### Para aumentar orçamento

Exigir, sempre que possível:

- qualidade estável ou melhorando;
- campanha limitada por orçamento nos termos que realmente interessam;
- capacidade operacional de atender os novos contatos;
- expectativa de custo por qualificado ou agendamento compatível;
- aumento gradual, normalmente sem outra grande mudança simultânea.

## 13. Diagnóstico e prioridade pré-auditoria

### Hipótese principal

A hipótese de trabalho, e não uma conclusão definitiva, é que existe procura compatível, mas ainda não está comprovado que o sistema de aquisição:

1. compra e captura organicamente as intenções mais valiosas com eficiência;
2. usa o lead qualificado como sinal real de lances;
3. faz anúncio, página, conteúdo e WhatsApp continuarem a mesma intenção;
4. produz confiança e valor percebido suficientes para a consulta;
5. permite que Google, busca local e buscadores com IA encontrem e interpretem corretamente a médica e seus serviços;
6. recebe volume bastante para automação de lances robusta;
7. consegue expandir para mama, lipoaspiração e abdominoplastia sem diluir face ou desperdiçar orçamento.

### Ordem de prioridade

1. Reconciliar Google Ads, GA4, Search Console, Perfil da Empresa, páginas e funil real até consulta e cirurgia.
2. Auditar ações de conversão, metas das campanhas, importação e taxa de correspondência dos identificadores.
3. Relacionar consultas pagas e orgânicas a páginas, conversas, qualificados e consultas.
4. Auditar rastreamento, indexação, experiência mobile, comunicação, presença local e descoberta em buscadores com IA.
5. Separar correções necessárias de hipóteses de crescimento e testar uma mudança relevante por vez.
6. Comparar realocação do orçamento atual com cenários de aumento e com a expansão secundária de mama e corpo.
7. Só então decidir sobre novas campanhas, novas páginas, lances, orçamento e expansão de canal.

## 14. Perguntas para a auditoria integrada

- Qual ação orienta os lances de cada campanha hoje?
- `Lead qualificado GCLID` está sendo importada sem erro e com qual taxa de correspondência?
- Ela é secundária ou participa de uma meta personalizada usada pelas campanhas?
- Existem conversões fracas sendo tratadas como principais?
- Há volume suficiente para Smart Bidding baseado em qualidade?
- Qual dado sustenta o CPA sugerido de R$ 134,41?
- Quais termos concentram gasto, contatos e qualificados?
- Quanto se perde por orçamento e por ranking nos temas de alta intenção?
- Quais consultas pagas e orgânicas produzem conversas reais, qualificados e consultas?
- Quais páginas ajudam ou interrompem a continuidade entre procura, confiança, WhatsApp e consulta?
- Há problemas de rastreamento, indexação, conteúdo, presença local ou interpretação da identidade da médica?
- Quais oportunidades existem para lifting facial, lifting cervical, lipo de papada, blefaroplastia, otoplastia, lip lifting e injetáveis?
- Qual ação mínima e controlada faz sentido para cirurgias da mama, lipoaspiração e abdominoplastia?
- Qual resultado pode vir de correção, realocação ou melhoria de página, e qual realmente exige aumento líquido de investimento?
- Quais experimentos devem ser executados primeiro, com qual duração e regra de interrupção?

## 15. Protocolo para futuras alterações

Antes da mudança, acrescentar uma entrada em `campanhas/HISTORICO-ESTRATEGICO-AQUISICAO.md` com status `Planejada` e atualizar neste documento a decisão vigente afetada. Depois da execução, preencher a data, responsável e estado `Em observação`. Ao final da janela, registrar o resultado e marcar `Mantida`, `Revertida` ou `Substituída`.
...
O histórico detalhado foi transferido para `campanhas/HISTORICO-ESTRATEGICO-AQUISICAO.md`. Este documento mantém apenas princípios, decisões vigentes, hipóteses em teste e estado necessário para decidir.

Toda nova mudança estratégica deve atualizar a seção vigente correspondente neste documento e receber, no mesmo trabalho, uma entrada no histórico separado.
...
**Publicação verificada em 03/09/2026:** o commit funcional `b845db8fb2cce7889abc6ae3e8334261ba3661da` foi publicado no Netlify pelo deploy `6a99862d5c80270008ebf19b`, em `production`, `ready` e com `commit_ref` idêntico. A negativa de frase `"lobuloplastia"` foi confirmada entre 61 negativas. O grupo infantil recebeu sete sitelinks específicos; o adulto preservou os seis existentes, corrigiu os dois destinos gerais para a página adulta e recebeu `Consulta de Otoplastia` e `Valor da Otoplastia`. As associações infantis de campanha e o link cervical em OTO foram apenas pausados. `Blefaroplastia` foi pausado no nível da conta, sem excluir o recurso, e associado diretamente à campanha BLEF com seu destino correto; o recurso cervical permaneceu ativo em CERV. Campanha e grupos seguem ativos, com R$ 15/dia, Maximizar cliques e meta específica `Lead qualificado GCLID — campanhas`; RSAs e as nove frases de destaque da campanha ficaram intactos. Apps Script v141 e todos os sistemas do funil permaneceram fora da escrita.
...
**Execução publicada e verificada em 12/09/2026:** após confirmação final de Daniel, o resumo selecionou somente 2 de 4 campanhas, 2 de 4 conjuntos e 0 de 3 anúncios. O contador de rascunhos caiu de 11 para 7. As campanhas e os conjuntos canônicos de `M26C01W` e `M26F01W` foram relidos como `Ativo`; cada campanha mostrou orçamento vitalício de R$ 900. Os dois términos foram relidos como 11/10/2026 às 23:59, GMT-3. Os anúncios C07/C06 permaneceram ligados, os herdados permaneceram desligados e os sete rascunhos antigos ficaram intocados.
...
- manter ativa a programação de `AJUSTES_GOOGLE_ADS`: `IMPORT_GOOGLE_ADS` envia novos qualificados, mas não substitui a retração de uma conversão já importada e posteriormente corrigida. O pré-voo confirmou seis linhas válidas, zero erro, fila de ajustes vazia e os dois recibos anteriores `confirmed_not_found`; portanto, a rotina fica inócua agora e disponível para correção idempotente futura;
...
**Estado de execução:** publicado e verificado ao vivo em 12/09/2026. Após autorização final de Daniel, o Meta confirmou `1 conjunto de anúncios e 1 anúncio foram publicados`; o contador voltou de nove para sete, preservando os sete rascunhos anteriores. O conjunto e o anúncio cervical foram relidos como `Ativo`, com as três cidades e os textos aprovados. A campanha facial permaneceu ativa e inalterada. Os dois orçamentos vitalícios continuam exatamente em R$ 900,00, sem limite adicional por conjunto e sem mudança de programação.
## 27. Decisão autorizada de 12/09/2026 — segundo lote educativo
...
## Decisão de continuidade — 12/09/2026, candidato local

Motivo: reduzir decisões repetitivas e dar continuidade delicada a pacientes já atendidas, sem confundir cuidado com aquisição. Evidência: cadastro vivo com 57 consultas no recorte, 28 nascimentos, zero aniversário habilitado e seis consentimentos preenchidos; sugestões diárias com identidade variável e envio aprovado restrito ao marketing. Hipótese: dispensas persistentes por marco e entrega do rascunho administrativo aprovado reduzem carga mental e repetição sem pressionar a decisão cirúrgica.

Manter o corredor automático atual de marketing. Cuidados após consulta/cirurgia/orçamento continuam humanos na decisão; a Bruna entrega apenas o texto administrativo revisto e sujeito a novo contexto. Aniversário é uma saudação sem oferta, condicionada a consentimento, cadastro e modelo aprovado. Nunca usar a data de aniversário como gatilho de venda. Calendar passado não prova comparecimento nem cirurgia. O histórico permanece a fonte de contexto e autoria; atribuição e conversão só avançam por evidência própria.

Métricas: reaparição de dispensas, mensagens duplicadas e desacordo texto aprovado/enviado (esperado zero); tempo de revisão diário, retornos úteis e consultas qualificadas; não otimizar volume de mensagens. Revisão: D+7 da ativação autorizada. Manter se reduzir carga e preservar qualidade; suspender as flags novas diante de contato inadequado, troca de profissional, duplicidade ou perda de contexto. Nenhuma alteração de campanha, orçamento, lance ou produção decorre desta decisão local.

## 30. Decisão autorizada de 12/09/2026 — descoberta orgânica e identidade verificável

**Decisão vigente:** melhorar a compreensão e a descoberta do site por Google e mecanismos de busca com IA, mantendo a linguagem acolhedora e breve das seções 28 e 29. A meta é a pessoa conhecer Amanda, esclarecer a dúvida que a trouxe e considerar uma consulta. Não produzir volume de artigos, clones por palavra/cidade, conteúdo escondido para robôs ou alegações de superioridade para tentar ganhar posição.

**Motivo e evidência:** pedido direto de Daniel e cinco exports do Search Console. Busca Web efetivamente observada de 09/07 a 10/09: 21 cliques/2.042 impressões; últimos 28 dias, 10/1.550, contra 7/424 nos 28 anteriores. Guias de custo de lifting facial, mama e corpo receberam 552/508/266 impressões e 3/0/0 cliques. A amostra é pequena; os dados não demonstram consultas nem resultado desta implementação. Algumas posições vieram como datas e são N/D. A cobertura termina em 03/09 e não representa todas as páginas publicadas depois. Evidência e método: `auditorias/seo-descoberta-ia-2026-09-12/RELATORIO.md`.

**Aplicação:** perfil institucional da Amanda com formação e registros verificáveis, identidade consistente de pessoa/clínica/site, endereço completo, breadcrumbs e links úteis, títulos e descrições fiéis à intenção da página, consolidação de URLs públicas duplicadas e correção estreita do endereço malformado identificado no GSC. A apresentação dos guias de custo melhora sem alterar valores, CTA, conteúdo clínico ou a política de orçamento individual. Preservar a distinção entre guia facial geral e cada procedimento.

**Confiança e limites:** revisão e autoria médicas somente com lastro real; nenhuma revisão nova é atribuída por um ajuste de SEO. Avaliação cardiológica incluída somente no pacote cirúrgico, sem promessa de exames ou substituição da avaliação anestésica. Horário de contato não é horário físico presumido. O perfil organiza a formação; não promete resultado. Regras de OAI-SearchBot e GPTBot continuam independentes e inalteradas. Não se garante indexação, ranking, aprovação de resultado enriquecido ou citação em IA.

**Hipótese:** identidade clara e apresentações mais úteis podem melhorar descoberta e a passagem de interesse orgânico para consulta. Maior exposição, clique ou CTR isoladamente não demonstram sucesso comercial. Esta execução não altera anúncios, verba, público, lances, conversões, bot, mensagens, LEADS, Apps Script, DNS ou Google Business Profile; os registros paralelos são preservados, não reexecutados.

**Métrica e revisão:** integridade imediata e em 24h após publicação; indexação por URL após recrawl; primeira leitura em 26/09 e comparação de 28 dias em 10/10. Avaliar contatos orgânicos válidos, qualificados e consultas quando houver atribuição confiável. Usar páginas, consultas, país e dispositivo do GSC sem misturar granularidades. Consultas anonimizadas, revisões simultâneas e amostra pequena limitam inferência. O relatório/controle de IA depende do que a propriedade efetivamente disponibiliza, sem afirmar acesso não obtido.

**Manter ou corrigir:** manter clareza, identidade factual e navegação íntegra; corrigir erro técnico ou informação inexata imediatamente. Não reverter por oscilação de curto prazo nem atribuir ganho causal a uma frase. Revisão clínica posterior continua sendo uma etapa humana. Janelas de observação não impedem novas correções e não criam automação. O Plano Executivo concentra pendências e recibos.

## 31. Decisão autorizada de 12/09/2026 — preço como planejamento
...
Fundamento: venda consultiva adaptada à saúde para entender a dúvida e comunicar valor pertinente, combinada a comunicação clara e decisão compartilhada (AHRQ SHARE). A aplicação de SPIN é uma adaptação de raciocínio, não evidência de aumento de conversão em cirurgia plástica. Relatório e fontes: auditorias/bruna-preco-2026-09-12/RELATORIO.md.

Hipótese: clareza e menor carga de leitura ajudam a pessoa a decidir se deseja uma consulta. Medir respostas úteis, contato qualificado → consulta, abandono após preço e falhas de revisão, por procedimento/origem. Conferência de integridade imediata/24h e leitura em D+7 (19/09), sem inferir causalidade por mudanças simultâneas ou baixa amostra. Manter enquanto fatos e limites forem respeitados; corrigir valor indevido, repetição, pressão ou referência incorreta. Não voltar a promessas indevidas para melhorar conversão.

## 32. Ajustes imediatos autorizados — 12/09/2026, Google Ads sem aumento de orçamento

**Autorização:** após a avaliação da conta, Daniel solicitou executar os ajustes considerados pertinentes no imediato. O pacote de configuração está separado do candidato técnico de site `0ff0dd2`; não publica site, Netlify, Apps Script ou bot.

**Decisão:** corrigir cinco códigos legados de campanha e três códigos de grupo em seis anúncios, conforme o registro canônico; completar somente GBRAID/WBRAID na conexão LEADS existente; testar a opção **Presença** no lugar de **Presença ou interesse** em `S_BR_SP_LIFTING_FACIAL` e `S_BR_SP_LIFTING_CERVICAL`, mantendo a cidade de São Paulo e os orçamentos R$24/R$12. Os demais seis orçamentos ficam intactos, total R$103/dia. Preservar Maximizar cliques, meta qualificada, redes, palavras, públicos demográficos, horários, textos, destinos, sufixos e recomendações automáticas desligadas. Sem teto de CPC arbitrário, ampliação de palavras ou novas ações de conversão neste lote.

**Evidência e hipótese:** seis anúncios ainda sobrescrevem os códigos canônicos; dois identificadores disponíveis não estavam mapeados. LIFT/CERV incluem interesse geográfico, enquanto BLEF já usa presença. Os reparos de códigos corrigem integridade; o recorte por presença é um teste de concentração em pessoas com logística mais viável, não prova de que pacientes de fora sejam ruins. Presença inclui quem frequenta São Paulo. Não adicionar exclusões de cidades/bairros nem inferir poder aquisitivo de localização. O risco de perder demanda externa viável deve ser acompanhado e pode justificar reversão do teste.

**Métrica e revisão:** primeiro ciclo/48h para saúde; leituras em 20/09 e 27/09; decisão em 13/10 ou após volume suficiente. Separar qualificado preparado, aceito e atribuído; consultas únicas agendadas e realizadas, por coorte com maturação e gasto correspondente. O lote do site continua pendente e impede declarar a mensuração integralmente resolvida. Não criar conversão de teste, executar importação manual, reaproveitar transação com data nova ou conceder consentimento presumido.

**Manter ou reverter:** manter reparos enquanto campos e IDs continuarem coerentes; reverter apenas o componente que causar perda/mistura de atribuição. Manter a restrição geográfica somente se preservar ou melhorar consultas úteis e eficiência; rever se excluir demanda externa viável. Baixa amostra é inconclusiva. O estado aplicado deve ser comprovado no recibo `auditorias/google-ads-ajustes-imediatos-2026-09-12/EXECUCAO.md`, nunca inferido deste plano.


## 33. Revisão editorial do site — publicada em 13/09/2026

**Decisão:** falar da escolha da Amanda com exemplos concretos de cuidado, não com superlativos. O nicho facial é a pessoa que compara cirurgiões, quer melhorar contorno/olhar e preservar a própria expressão, valoriza formação e preparo e precisa organizar consulta, recuperação e investimento. Foco em face é descrição da prática confirmada por Daniel, não título adicional de especialidade. Nas páginas de mama e corpo, manter a competência pertinente àquela demanda; não introduzir exclusividade facial.

**Evidência:** GA4 de 14/06 a 11/09/2026; Google Ads de 05 a 11/09; agregado LEADS gerado em 13/09 às 08h10 BRT, com coorte de 14/08 a 12/09. Há procura por procedimento, preço, naturalidade, antes/depois e recuperação. No agregado de 30 dias, 20 contatos identificados e somente um classificado; os outros 19 não são desqualificados por ausência de classificação. As janelas não foram somadas nem usadas para calcular conversão Ads → consulta. Fontes, limites e alterações por página: `auditorias/site-comunicacao-2026-09-13/RELATORIO.md` e `REVISAO.json`.

**Aplicação:** aberturas específicas, autoria da consulta, linguagem simples, menos frases repetidas sobre “planejamento” e “decidir com calma”; informação de consulta particular de R$ 500 próxima ao convite nas páginas comerciais principais. Preço cirúrgico continua individual, sem novas faixas públicas. Perguntar preço é legítimo; não inferir capacidade financeira por cidade, aparência, idade ou pela dúvida. Segurança permanece em primeiro lugar: cardiologia na própria LIV incluída no pacote cirúrgico, formação USP atribuída ao cardiologista e anestesistas selecionados com critério. Primeira consulta e exames não são incluídos por extensão; cardiologia não substitui anestesia. A naturalidade é objetivo, não resultado garantido.

**Escopo e autorização:** Daniel solicitou a revisão do site e posteriormente autorizou: “ok, publique quando for adequado.” A autorização alcança este pacote editorial reconciliado ao release paralelo verificado, com o HEAD exato registrado no preflight de publicação. Substitui, neste escopo, as antigas restrições de não alterar o site ou congelar textos dos guias de custo. Não altera regras clínicas, preço, URLs, códigos, tracking, campanhas, verba, bot, mensagens ou dados. O candidato técnico de atribuição `0ff0dd2` continua separado. Nenhuma revisão médica nova é atribuída.

**Hipótese e acompanhamento:** reduzir ambiguidades pode facilitar a escolha de consultar Amanda. Publicado em 13/09/2026 às 10h22 BRT, commit `77433528d0247c46f5482db29932094e0f534783`, Netlify `6aa6a37365ed3d0008e3d1cc`, com as 54 páginas verificadas. Não há aumento de vendas demonstrado. Em D+7 (20/09), D+14 (27/09) e D+30 (13/10), Daniel/equipe devem avaliar cobertura de classificação, contatos válidos/qualificados e consultas agendadas/realizadas por coorte e procedimento. Origem por página/CTA continua N/D onde ausente. Integridade imediata/24h; nenhuma automação criada. Alterações simultâneas em anúncios e atendimento impedem isolar o efeito de uma frase.

**Manter ou corrigir:** manter enquanto a informação for verdadeira, compreensível e os caminhos de contato estiverem íntegros. Corrigir imediatamente promessa, confusão sobre consulta/pacote, erro clínico ou regressão técnica; revisão clínica humana permanece pendente. Reavaliar a posição do valor da consulta se houver perda consistente de contatos válidos e consultas, com classificação suficiente. Não retirar transparência nem voltar a promessas para aumentar cliques.

## 34. Decisão autorizada de 13/09/2026 — Central de retomadas prática e contextual

**Decisão vigente:** a Central aberta pelo e-mail diário deve reduzir o trabalho de revisão sem decidir pelo humano. Cada sugestão pronta terá cópia em um toque e usará somente o primeiro nome seguro e o ponto já conhecido da conversa — procedimento, dúvida, objeção, convite de agenda ou material — quando esse contexto estiver inequívoco. Dado ausente, nome impróprio ou assunto ambíguo mantém texto neutro. O valor da consulta permanece separado de preço cirúrgico, e nenhuma faixa nova é criada pela retomada.

O painel passa a oferecer, para retomadas proativas com telefone válido, **Cancelar retomadas definitivamente**. A ação não vem marcada, exige seleção e confirmação explícitas, grava a preferência canônica `Nunca retomar` e cancela os planos pendentes daquele contato. Ela não é exibida em lembrete operacional de consulta e não cancela consulta, Calendar ou lembrete de compromisso confirmado. `Nunca responder` continua fora do painel, pois bloquear respostas reativas exige revisão individual.

**Motivo e evidência:** feedback direto de Daniel de que faltavam cópia rápida, contexto na mensagem e uma saída definitiva além do adiamento. A cópia reproduz exatamente o texto visível; não aprova nem envia. Casos clínicos, sensíveis, de preço não autorizado ou com contexto insuficiente continuam como ação humana e, quando aplicável, chegam com rascunho para revisão.

**Hipótese, métrica e revisão:** menos etapas de copiar e uma sugestão coerente com a conversa devem reduzir carga mental e retrabalho sem aumentar pressão sobre pacientes. Verificar no primeiro painel, em 24 horas e em 72 horas: igualdade entre texto mostrado e copiado, ausência de mensagens duplicadas, reaparição após cancelamento definitivo (esperado zero), preservação de lembretes confirmados e decisões aplicadas somente ao telefone escolhido. Manter enquanto esses invariantes forem preservados; restaurar a versão anterior do Apps Script se houver texto divergente, bloqueio de outro contato, perda de lembrete ou decisão sem confirmação.

**Estado de execução:** publicado e verificado na Apps Script v152 em 13/09/2026, no deployment canônico preservado, a partir do commit funcional `7a5cf98bebbe571014f0721ee8df1c85a99ecf79`. Os três arquivos vivos coincidiram com o commit aprovado e o pós-voo somente leitura não acionou e-mail, mensagem, consulta, preferência ou cancelamento real. Rollback: v151 no mesmo deployment.

## 35. Otoplastia — escolha da cirurgiã e continuidade, 13/09/2026

**Decisão autorizada por Daniel:** rever a comunicação dos dois RSAs e das páginas adulta/infantil da campanha G26OTO, sem aumentar orçamento. R$ 15/dia permanece; nenhum outro orçamento, lance, meta, palavra, rede, público ou atribuição muda. Este pedido permite o ajuste textual durante a janela iniciada em 12/09, cuja simultaneidade passa a ser limitação analítica expressa. O estado aplicado é comprovado em auditorias/otoplastia-estrategia-2026-09-13/PUBLICACAO.json.

**Motivo e evidência:** o histórico Google até 12/09 contém 357 cliques/R$ 788,89; as seis conversões da interface não equivalem a consultas. Na coorte canônica de 90 dias há três contatos G26OTO, todos Novo/aguardando paciente, sem classificação, qualificação ou consulta registrada. Dois resumos apontam objeção Preço; um, silêncio após explicação da consulta. São pistas com amostra pequena, não prova de inviabilidade, de preço excessivo ou de desqualificação. Adulto concentra 92,37% do gasto; infantil tem apenas 29 cliques. Não somar janelas ou projeções para criar taxas de conversão.

**Mensagem:** tornar explícita a formação médica e as residências em Cirurgia Geral/Cirurgia Plástica pela Unicamp, CRM-SP 191605/RQE 110472. Relacionar formação ao exame de forma, dobras, projeção e proporção de cada orelha, à discussão de cicatrizes e recuperação e à consulta com a própria cirurgiã. No infantil, ouvir a criança e respeitar quando esperar é melhor. Mostrar consulta particular de R$ 500 no anúncio e junto ao convite; manter faixa cirúrgica privada, informativa e após o contexto/aceite já regidos pelo atendimento. Não mudar Bruna ou contatar casos antigos.

**Diferenciação responsável:** não afirmar superioridade de resultados ou segurança sobre otorrinos/dentistas, nem ausência de formação de toda uma profissão. A matriz oficial de Otorrinolaringologia inclui otoplastia; normas odontológicas mudaram em 2026. A escolha da Amanda se apoia em suas credenciais verificadas, relação entre formação e cuidado e critérios objetivos de escolha. A auditoria registra fontes primárias e limites. Não substituir uma alegação falsa por insinuar que outros só fizeram curso rápido.
...
**Estado de execução:** pacote publicado em 13/09/2026, commit 030c57da84878f0910111d5e8de2a71b91538e82, Netlify 6aa6ab8ec7bf45000934fe35, ready às 2026-09-13T13:57:01.241Z. Os dois RSAs existentes foram salvos e relidos, com textos exatos, descrição1 fixada e URLs/parâmetros preservados. R$15/dia mantidos; Apps Script152 e funções herdados. Reavaliação breve16/09 às9h BRT confirmada em automação da tarefa. Recibo completo e projeções: auditorias/otoplastia-estrategia-2026-09-13/PUBLICACAO.json.

## 36. Contenção de face genérica e intenção cervical observada — 13/09/2026

**Decisão autorizada:** Daniel autorizou aplicar as modificações julgadas necessárias nas campanhas Google. O primeiro pacote fica restrito a duas campanhas, sem site: reduzir `G26FACE` de R$ 8 para R$ 4/dia, pausar sem excluir a frase `cirurgiã plástica em são paulo` em `AG_CIRURGIA_FACIAL` e tentar tornar explícitas quatro palavras exatas já observadas em `G26CERV`: `[lipo de papada valor]`, `[cirurgia de papada preço]` e `[lipo de papada preço]` em `AG_LIPO_PAPADA`; `[cervicoplastia valor]` em `AG_CERVICOPLASTIA`. `G26CERV` permanece em R$ 12/dia e o total passa de R$ 103 para R$ 99/dia.

**Motivo e evidência:** de 14/08 a 12/09, `G26FACE` teve 131 cliques, R$ 239,81 e zero qualificado atribuído. A frase genérica concentrou 118 cliques/R$ 215,61, ou 89,9% do gasto, sem qualificado. Entre os termos pagos divulgados, predominou procura nominal por terceiros, mas a cobertura foi parcial e o relatório não informa a palavra acionadora; portanto, a decisão contém a compra genérica sem afirmar que toda a parcela oculta é ruim. As quatro candidatas cervicais são consultas literais com 3–11 cliques já captadas no período e cumprem o gate existente de pelo menos três cliques para tornar uma intenção observada explícita.

**Recomendações do Google não aplicadas:** `[procedimento para papada]`, `[estetica papada]` e `[gordura queixo]` não substituem os termos de preço observados; `estética` ainda conflita com uma negativa da campanha e `procedimento` pode misturar alternativas não cirúrgicas. Também ficam recusados aumentos automáticos de orçamento, Maximizar conversões, Display, parceiros, Performance Max/Merchant Center, orçamento compartilhado e remoção em massa de exatas. A pontuação de otimização não é objetivo comercial.

**Estado aplicado em 13/09 às 20h15 BRT:** orçamento de `G26FACE` relido em R$ 4/dia, frase genérica relida como `Pausada`, `G26CERV` preservada em R$ 12/dia e total da conta relido em R$ 99/dia. Foram criadas e relidas como `Pendente / Em análise` três exatas: `[lipo de papada valor]`, `[lipo de papada preço]` e `[cervicoplastia valor]`. O Google bloqueou `[cirurgia de papada preço]` em `Health in personalized advertising`; a palavra não foi criada, não houve solicitação de exceção e nenhum termo amplo a substituiu. Criação não antecipa aprovação nem resultado comercial; reler política e entrega no ciclo de integridade.

**Invariantes:** preservar os outros sete orçamentos, lance e CPC existentes, meta qualificada, ações de conversão, redes, geografia por presença, idiomas, idade, dispositivos, agenda, RSAs, fixações, URLs, parâmetros, recursos, negativas existentes e intenções de preço. Nenhuma conversão, contato ou classificação é criada; LEADS, CRM, Apps Script, WhatsApp, Calendar, Meta, site e Netlify ficam intactos.
...
## 37. Piloto aplicado e verificado — Maximizar conversões em lifting facial, 13/09/2026

**Decisão aplicada em 13/09/2026 às 21h04 BRT:** lifting facial é a campanha mais importante para Daniel. Ele autorizou usar `S_BR_SP_LIFTING_FACIAL` (`G26LIFT`, ID `24028216444`) como piloto de Maximizar conversões e definiu o orçamento exato em R$ 30/dia. O pacote troca somente o lance de Maximizar cliques para Maximizar conversões, sem CPA desejado, e eleva somente `G26LIFT` de R$ 24 para R$ 30/dia. A releitura final confirmou a conta em R$ 105/dia, partindo de R$ 99/dia. A recomendação do Google de R$ 47/dia não foi autorizada e fica recusada.

**Motivo e evidência:** face continua sendo o eixo estratégico e lifting é a prioridade declarada. O lance automatizado pode usar sinais de leilão e dados da conta, mas a evidência downstream ainda é fraca: na coorte canônica de 14/08 a 12/09 há sete contatos identificados em `G26LIFT`, todos atualmente em `Novo`, sem qualificado ou consulta registrada. A LEADS contém sete eventos qualificados em estado `ready`, um resolvido para LIFT, e a leitura viva posterior mostrou uma conversão na ação principal entre 14/08 e 12/09, com última conversão em 01/09. Isso não comprova o aceite dos sete eventos da LEADS. Isso sustenta um piloto estreito e reversível; não sustenta R$ 47, CPA desejado ou generalização para as outras campanhas.

**Preflight e estado:** a primeira tentativa foi bloqueada pelo runtime e está preservada em `PREFLIGHT.json`. Na retomada explicitamente autorizada para `ba73148`, o navegador autenticado funcionou e confirmou conta/campanha, Maximizar cliques, R$ 24/dia, meta qualificada, ação principal com aviso de ausência de dados recentes, oito orçamentos R$ 99/dia e aplicação automática em 0/7 e 0/14. O gate do SHA exato passou antes da escrita. Foram salvos Maximizar conversões sem CPA desejado e R$ 30/dia; o editor foi reaberto e a tabela recarregada confirmou os oito orçamentos, total R$ 105/dia e LIFT em aprendizado. Recibo: `auditorias/google-ads-lift-max-conversions-2026-09-13/PUBLICACAO.json`. O histórico consultado imediatamente após ainda não exibiu as novas entradas; confirmar sua propagação na revisão de integridade, sem substituir a releitura dos campos já persistidos.
...
**Execução verificada:** campanha `24028216444`, Maximizar conversões, CPA desejado ausente, orçamento individual R$ 30, meta qualificada preservada. Outros sete orçamentos: BLEF 23, OTO 15, CERV 12, FACE 4, MARCA 5, CORPO 8 e MAMA 8; total da conta R$ 105/dia. Nenhuma outra configuração foi salva.
...
**Revisão e rollback:** ativação verificada em 13/09 às 21h04 BRT; integridade em 14/09 e 15/09; D+7 em 20/09, D+14 em 27/09 e D+28 em 11/10 no mesmo horário, por Daniel/equipe e sem nova automação. Reverter somente `G26LIFT` para Maximizar cliques sem teto de CPC e R$ 24/dia se surgir CPA inesperado, orçamento diferente de R$ 30, total diferente de R$ 105, falha de meta/atribuição, mudança concorrente indevida, gasto anormal ou regressão downstream consistente com mensuração saudável. Preservar histórico e toda mudança não pertencente a este pacote.

## 38. Termos relevantes e recursos nos RSAs — 13/09/2026

**Decisão autorizada:** Daniel pediu aplicar as sugestões de qualidade em todos os anúncios ativos. Foram conferidos 17 RSAs em oito campanhas. Seis editores carregados já indicam Excelente e não requerem alteração de texto. Onze recebem termos específicos do próprio procedimento nos títulos e descrições, sem repetição artificial ou promessa de resultado. O registro exato de antes/depois está em `auditorias/google-ads-qualidade-2026-09-13/REVISAO.json`.

**Recursos:** três grupos de preço pedem mais dois sitelinks. O seletor associa no nível da campanha; reutilizar dois links gerais de mama em `S_BR_SP_CIRURGIA_MAMA` (possibilidades e custos) e dois de corpo em `S_BR_SP_CONTORNO_CORPORAL` (diferença entre lipo/abdominoplastia e custos). Preservar os quatro recursos de conta e todos os de grupo existentes; não editar os recursos compartilhados.

**Motivo, hipótese e limites:** tornar o anúncio mais aderente à busca e disponibilizar destinos úteis pode melhorar a qualidade dos contatos. A nota do Google é um diagnóstico editorial, não o objetivo de aquisição. A listagem pode estar desatualizada frente ao editor. Nunca substituir clareza e precisão médica por frases geradas sem sentido. As revisões de OTO, site e lance LIFT recentes impedem atribuir causalidade isolada ao texto.

**Invariantes:** descrição médica1 fixada, CRM/RQE, títulos de até30 e descrições de até90 caracteres, consulta OTO R$500, formação e participação da criança preservadas. Sem mudanças de URLs de RSA, parâmetros, fixações, palavras, negativas, redes, segmentação, metas, lances ou orçamento. LIFT segue Maximizar conversões sem CPA/R$30; total R$105. Aplicação automática continua desligada. Sem mudanças de site, atendimento ou dados de pacientes.

**Revisão e rollback:** Daniel/equipe verificam integridade e política em14–15/09 e contatos válidos, qualificados aceitos, consultas e custo por etapa em21/09 e28/09. Baixa amostra/classificação incompleta é inconclusiva. Restaurar somente textos ou associações responsáveis por reprovação, erro ou regressão consistente, usando o banco before. Nenhuma nova automação. Estado aplicado depende de PUBLICACAO.json e releitura viva.
...
## Convite a avaliação pública — decisão de 20/09/2026

Convite Google somente ao perfil da Dra. Amanda, após atendimento registrado como realizado. Sugestão entre D+7 e D+30, com aprovação individual da equipe; uma única chave por telefone em todas as consultas. Sem nota solicitada, incentivo, texto de avaliação pronto, seleção por elogio ou cobrança por silêncio. Preferências, pendências, contexto, consentimento, Calendar e CRM são relidos antes do envio. Nenhum convite em conversa de captação; não confundir avaliação pública com consulta médica.

Motivo: solicitação de Daniel nesta tarefa, com destino confirmado somente para Amanda. Evidência: perfil público e formulário de avaliação verificados; regras oficiais do Google proíbem incentivos, pressão e solicitação seletiva de avaliações positivas. Hipótese: um convite discreto após experiência real facilita relatos espontâneos. Métricas: convites individuais aprovados/aceitos, duplicidades, recusas e bloqueios por contexto; nota ou número de avaliações não é conversão de marketing. Revisão: 22/09 e 27/09, ou primeiro envio aprovado. Manter com zero repetição e respeito às preferências; conter diante de contato ou perfil incorreto. Nenhuma campanha, orçamento ou lance alterado.
