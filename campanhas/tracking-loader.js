(function () {
  ...
  function injectConsentBanner() {
    ...
    style.textContent = `.cookie-consent{position:fixed;left:16px;right:16px;bottom:calc(16px + env(safe-area-inset-bottom));z-index:9999;max-width:760px;margin:0 auto;padding:16px;background:#fffaf7;border:1px solid rgba(80,55,48,.18);box-shadow:0 20px 60px rgba(55,35,28,.18);border-radius:18px;color:#392720;font-size:13px;line-height:1.4}.cookie-consent strong{display:block;margin:0 0 4px;font-size:15px}.cookie-consent p{margin:0;color:rgba(57,39,32,.78)}.cookie-consent-actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:10px}.cookie-consent button{border:1px solid rgba(80,55,48,.22);background:transparent;color:inherit;border-radius:999px;padding:8px 12px;font:inherit;cursor:pointer}.cookie-consent .accept{background:#51362f;color:#fff;border-color:#51362f}.cookie-consent .privacy-policy{display:inline-flex;align-items:center;color:inherit;text-decoration:underline;padding:8px 2px}@media(max-width:760px){.cookie-consent{left:12px;right:12px;bottom:calc(12px + env(safe-area-inset-bottom));padding:13px;font-size:12.5px;line-height:1.35}.cookie-consent-actions{display:grid;grid-template-columns:1fr 1fr;margin-top:9px}.cookie-consent button{width:100%;padding:8px 9px}.cookie-consent .privacy-policy{grid-column:1/-1;padding:2px 1px}}`;
