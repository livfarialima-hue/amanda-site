(function () {
  ...
  function injectConsentBanner(force) {
    ...
    if (!document.getElementById('amanda-consent-style')) {
      ...
      style.textContent = '.cookie-consent{position:fixed;left:16px;right:16px;bottom:calc(16px + env(safe-area-inset-bottom));z-index:9999;max-width:700px;margin:0 auto;padding:22px 24px;background:#fffaf7;border:1px solid rgba(80,55,48,.18);box-shadow:0 20px 60px rgba(55,35,28,.18);border-radius:18px;color:#392720;font-size:14px;line-height:1.5}.cookie-consent-title{display:block;margin:0 0 8px;font-size:18px;line-height:1.25;letter-spacing:-.01em}.cookie-consent p{margin:0;color:rgba(57,39,32,.82)}.cookie-consent .privacy-note{margin-top:10px;padding-top:10px;border-top:1px solid rgba(80,55,48,.12);color:#392720;font-weight:600}.cookie-consent-actions{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:18px}.cookie-consent button{min-height:44px;border:1px solid #51362f;border-radius:999px;padding:10px 16px;font:inherit;font-weight:600;cursor:pointer}.cookie-consent .accept{background:#51362f;color:#fffaf7}.cookie-consent .reject{background:transparent;color:#392720}.cookie-consent button:focus-visible,.cookie-consent .privacy-policy:focus-visible{outline:3px solid rgba(81,54,47,.42);outline-offset:3px}.cookie-consent .privacy-policy{grid-column:1/-1;justify-self:start;color:rgba(57,39,32,.78);font-size:13px;text-decoration:underline;text-underline-offset:3px;padding:2px 4px}@media(max-width:560px){.cookie-consent{left:12px;right:12px;bottom:calc(12px + env(safe-area-inset-bottom));padding:18px;font-size:13.5px}.cookie-consent-title{font-size:17px}.cookie-consent-actions{grid-template-columns:1fr;gap:9px;margin-top:16px}.cookie-consent button{min-height:46px}.cookie-consent .privacy-policy{justify-self:center;margin-top:2px}}';
