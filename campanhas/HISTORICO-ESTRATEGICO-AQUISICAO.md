...
## 12 de setembro de 2026 — roteamento publicado por intenção nas campanhas secundárias

- **Status:** publicado e verificado ao vivo; monitoramento de integridade em 24 horas e de negócio em D+7/D+14/D+30.
...
- **Mudança publicada:** `AG_CIRURGIA_MAMA_PRECO` e `AG_CONTORNO_CORPORAL_PRECO` foram ativados com RSAs para os guias gerais e oito palavras com a correspondência preservada. As cinco originais de frase ficaram pausadas, as três originais exatas conflitantes foram removidas e as seis negativas exatas de roteamento foram verificadas nos grupos de origem. Campanhas, R$ 8/dia em cada uma, lances, meta qualificada, redes, geografia, idades, dispositivos, agenda, sitelinks e os cinco RSAs anteriores foram preservados.
...
- **Mensuração e lógica:** `ag_cirurgia_mama_preco` e `ag_contorno_corporal_preco` foram publicados no deployment canônico v148. O agregado aceita grupo e landing exatos, mas não transforma uma procura geral de preço em mastopexia, prótese, lipo ou abdominoplastia sem manifestação da pessoa. A rotina somente leitura reconhece os procedimentos e o orçamento total vigente de R$ 103/dia; seu código vivo coincide com SHA-256 `e6221436e176125d22ffdb48f28f1ea06689a8a324225c4c885556a16a59401f` e a agenda diária 09:00–10:00 foi preservada.
...
- **Recibos:** commit funcional autorizado `a9a0d4651a07e5d872d282daf93dd6ee95b7ebe5`; Apps Script v148; remoção das três exatas antigas `6838173976875543099`; inclusão das três negativas que faltavam `6049664068878736920`. Os dois novos RSAs foram relidos como ativos e `Qualificados`; páginas e sitemap permaneceram íntegros e não exigiram republicação.
