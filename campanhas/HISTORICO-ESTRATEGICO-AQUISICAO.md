...
- **Status:** Google Ads e Apps Script publicados e verificados; integração Git, projeção do Plano no Drive e publicação do consumidor Netlify pendentes de autorização do novo commit preservador.
