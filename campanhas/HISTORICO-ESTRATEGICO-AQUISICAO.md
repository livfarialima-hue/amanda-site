...
- **Reconstrução do lifting facial em 17/08:** a extensão do objeto histórico foi descartada. Foi preparada, sem publicação, a nova campanha de Tráfego `120251254720690627`, conjunto `120251254720700627`, anúncio `120251254720680627`, com WhatsApp, R$ 300 total, janela 17/08 12h–01/09 12h, São Paulo +20 km, 40–65+ rígido, todos os gêneros e somente `C06H01`; o anúncio herdado `120251254720710627` permaneceu desligado. O criativo usa as versões 1:1 e 9:16 do vídeo vencedor de 46,9 s, texto e modelo `M26F01W-C06H01`. A configuração do rascunho não prova entrega; publicação e `age_min=40` ainda dependem do gate técnico e da conferência pós-publicação.
