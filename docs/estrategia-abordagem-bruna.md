...
**Aniversários — envio manual solicitado em 13/09/2026:** mudança local validada nos testes focados, pendente de publicação. A mensagem ficará completa no lembrete do próprio dia, para a equipe copiar e enviar. Não exige habilitação de “Aniversário pelo bot” nem aprovação de modelo do WhatsApp. O painel permite dispensar a sugestão, sem aprovar envio pela Bruna ou adiar o aniversário. A autorização anterior para ativação automática está substituída por esta decisão. Nenhum envio automático de aniversário pode ser reativado por flags antigas ou por eventual aprovação do modelo. Demais cuidados aprovados permanecem preservados.
