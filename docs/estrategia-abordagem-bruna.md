...
**14/09/2026 — redução geral de repetição: candidato validado localmente, publicação autorizada.** A prioridade definida pelo usuário é a continuidade em toda conversa. Evitar repetição de explicações com sinônimos, perguntas respondidas, fórmulas de empatia e convites; cada turno usa a informação nova. Respostas completas breves são preferíveis a um ritual de acolhimento, microvalor e CTA. Repetir quando a pessoa pedir ou o limite for necessário, sem afrouxar faixas cirúrgicas. Uma revisão de rascunho no mesmo prazo original, sem novo ciclo de evento; preservar fato novo, valores, agenda, takeover e deduplicação. Hipótese: menos atrito e maior continuidade, sem pressão. Medir repetição, dúvidas respondidas, revisão humana, latência e consultas com evidência. Revisões em 16/09 e 21/09 às 19h BRT; conter diante de perda de resposta útil ou regressão de envio. Evidência: `auditorias/bruna-redundancia-2026-09-14/RELATORIO.md`. Campanhas, atribuição, valores e Apps Script preservados.
<!-- /BRUNA-REDUNDANCIA-2026-09-14 -->
