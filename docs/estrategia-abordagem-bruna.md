...
**Pacote 2026-09-14.1 — IMPLEMENTADO LOCALMENTE, AINDA NÃO PUBLICADO:** continuidade sem repetir apresentação/pergunta; acolhimento específico; pergunta com agradecimento continua pedindo resposta; ciência da informação não autoriza agenda; preço perguntado não é objeção presumida. Nome próprio declarado prevalece no tratamento e pode corrigir cadastro de aquisição; contato de familiar não vira nome da paciente. Central projeta o CRM e exige revisão para estado antigo, identidade ambígua ou anexo sem conferência. Retorno datado vira tarefa humana; despedida/emoji não encerra compromisso. Recibos aceitos pelo provedor podem reparar o histórico sem reenviar. O recibo publicado abaixo continua histórico; não representa este candidato. Detalhes e validação: auditorias/bruna-experiencia-processo-2026-09-14/RELATORIO.md.
