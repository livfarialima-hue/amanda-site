...
**Decisão local candidata — pedido direto de Instagram e referências internas:** quando a mensagem atual pedir Instagram, Insta, perfil oficial, rede social ou arroba da Dra. Amanda, a resposta se limita ao perfil oficial `https://www.instagram.com/dra.amanda_plastica/`. A presença de `Ref.`, código ou origem de anúncio em qualquer mensagem anterior não autoriza explicar rastreamento, campanha ou identificadores internos. Códigos de campanha, JID e IDs operacionais nunca devem aparecer nem ser explicados ao paciente. Se a própria pessoa perguntar diretamente o significado da referência, a resposta se limita a informar que ela pode desconsiderá-la e que isso não muda seu atendimento. Esta decisão está implementada apenas como candidata local e ainda não representa publicação.
