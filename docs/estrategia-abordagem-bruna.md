...
**14/09/2026 — recuperação com duas correções, pacote final testado e publicação em preparação.** O SDK corrigido já está ativo no commit `fd8b7a78c245fff3a1180e636db1d730bd6fa132` / Netlify `6aa8180f6bc83b386142c5fc`. O pós-voo identificou também tarefas longas interrompidas pelo limite de 30 segundos do agendamento. O candidato move a execução para background autenticado, amplia a reserva para 16 minutos, reserva um job por vez e bloqueia replay antigo ou excessivo. 1.535/1.535 testes integrais, 41/41 focados e 158/158 entre consumidores. Apps Script v153 mantido. Nenhum replay do caso. Detalhes: `auditorias/bruna-entrada-recuperacao-2026-09-14/RELATORIO.md`.
<!-- /BRUNA-ENTRADA-RECUPERACAO-2026-09-14 -->
