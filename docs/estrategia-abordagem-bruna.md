...
**Pacote 2026-09-18.1 — TESTADO LOCALMENTE; publicação autorizada pelo usuário.** O pacote cobre os seis pontos do diagnóstico: reserva recuperável de classificação, prevalência da intenção recente, elegibilidade administrativa da Bruna, compromissos por solicitação/oportunidade, aceites naturais e pausas na retomada, e biblioteca de cinco respostas administrativas aprovadas. A clínica continua responsável enquanto houver compromisso humano pendente; baixa confiança sobre a fase não impede identificar uma pergunta administrativa coberta por fato aprovado, mas a fase permanece protegida. Elegibilidade na Central depende dos gates reais de cada turno e não comprova um envio. Cuidado, tomada humana atual, preferências, confirmação de agenda e política de preço permanecem obrigatórios.

A reserva passa a usar o mesmo identificador nas tentativas de leitura da resposta, evitando alugar outro lead após timeout. O caminho novo dispensa a varredura do histórico de incidentes sob a trava global. Apps Script será publicado antes do cliente Netlify, preservando o protocolo antigo; só depois serão materializadas as cinco regras, as três colunas adicionais de compromissos e a recuperação única de até quatro classificações técnicas de 15–16/09. Nenhuma pendência humana histórica será encerrada por inferência.

Baseline: Apps Script v155, commit funcional `162c283c29cc7e7895a28ef7f1bbda9986dfc48e`, Netlify `6aac860da2c8aa0008212017`; os 27 arquivos Apps Script coincidem com a produção antes da escrita. Validação: 237 testes focados, 1.607 testes integrais e 16 grupos de consumidores aprovados, além de arquitetura, contrato e artefato do site. Rollback: restaurar esse deployment Netlify e Apps Script v155 no mesmo endereço; manter colunas adicionais e histórico, desativando somente as novas regras de conhecimento se necessário. Monitorar o primeiro ciclo e as primeiras conversas, com revisão em 48 horas: expirações, classificação/pendências, aceites cumpridos, retomadas após pausa, duplicidade e encaminhamentos humanos. Evidência: `auditorias/bruna-autonomia-2026-09-18/RELATORIO.md` e `PUBLICACAO.json`. Ganho comercial ainda não medido.
<!-- /BRUNA-AUTONOMIA-2026-09-18 -->
