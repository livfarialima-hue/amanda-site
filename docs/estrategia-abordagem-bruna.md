...
**Último release publicado:** verificado em 23/08/2026. A resposta ao valor da consulta presencial agora é curta e contextual: informa `R$ 500`, pagamento e nota fiscal, evita repetir explicação da avaliação e localização já apresentadas e oferece verificar opções sem pressão. Pergunta apenas de preço não recebe Maps nem coleta de agenda. A Central usa a mesma sugestão. Código funcional `d6c896a23edffa942b9dc34ba16c1f3a847dbb76`, deploy Netlify `6a8b89d97d701d000895f77f` e Apps Script v128 preservado; **159/159 testes focados** e **1054/1054 testes integrais**. Os endpoints canônico e imutável responderam HTTP 200 em modo `active`. Nenhuma mensagem real foi enviada. Rollback: código `28d1238520e9fd98c215848f13c868a2a2112adb`, deploy `6a8b7d212bc77a000868548e` e Apps Script v128 sem alteração.
