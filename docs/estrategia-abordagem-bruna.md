...
**Último release publicado:** verificado em 24/08/2026. Perfis ambíguos ou não pessoais não são usados como nome; no primeiro contato sem nome confiável e sem histórico, a Bruna responde ao interesse e pergunta apenas `Como posso te chamar?`. Nomes pessoais válidos continuam preservados e o nome não é pedido novamente depois de atendimento anterior. Código funcional `6ada6da31c99f565aca12ec79106e0d7a861ac7a`, deploy Netlify `6a8ca7dffa99ff87e5d5c828` e Apps Script v128 preservado; **121/121 testes focados** e **1062/1062 testes integrais**. Os endpoints canônico e imutável responderam HTTP 200 em modo `active`. Nenhuma mensagem real foi enviada. Rollback: código `e05568959cda331d08a3a21a9e48666c395dabb8`, deploy `6a8c71d99ed4e60008eb7847` e Apps Script v128 sem alteração.
