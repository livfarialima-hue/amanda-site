...
**14/09/2026 — correção da recuperação testada localmente; publicação autorizada em preparação.** A atualização Netlify Blobs 10.7.10 → 10.7.12 preserva reservas, tentativas e prazos; o job só relata reagendamento quando a gravação confirma. Validação: 1.521/1.521 testes integrais, 27/27 focados e 158/158 entre consumidores. O caso já foi encerrado por atendimento humano; nenhum replay. Detalhes em `auditorias/bruna-entrada-recuperacao-2026-09-14/RELATORIO.md`.
<!-- /BRUNA-ENTRADA-RECUPERACAO-2026-09-14 -->
