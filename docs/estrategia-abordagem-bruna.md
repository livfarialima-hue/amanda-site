...
**Último release publicado:** verificado em 25/08/2026. Nomes pessoais claros com emoji ou decoração somente nas bordas são limpos e usados pelo primeiro nome; siglas, empresas, números e símbolos internos continuam bloqueados. No primeiro contato sem nome confiável e sem histórico, a Bruna responde ao interesse e pergunta apenas `Como posso te chamar?`. Código funcional `6a90eb2131da050362aa2a9bb5fccf3fac5c0c07`, deploy Netlify `6a8da9472f5f4b41e5fce6d7` e Apps Script v128 preservado; **125/125 testes focados** e **1066/1066 testes integrais**. Os endpoints canônico e imutável responderam HTTP 200 em modo `active`. Nenhuma mensagem real foi enviada. Rollback: código `16b01166667458fa0ffd285610adcba4bf7acbe6`, deploy `6a8ca9ff1503800008d4ddaf` e Apps Script v128 sem alteração.
