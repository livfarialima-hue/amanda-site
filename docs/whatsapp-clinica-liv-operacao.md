...
2. marcar `Aprovar com a Bruna` ou `Cancelar retomada` nas linhas desejadas;
3. abrir `Central LIV > Processar decisões marcadas`;
4. conferir separadamente as quantidades que irão para a Bruna e que serão canceladas e confirmar uma única vez.
...
O e-mail diário inclui um botão direto para essa aba. Na coluna `Próxima ação`, o amarelo identifica uma ação humana geral prevista para as próximas 24 horas e o roxo identifica uma retomada humana sugerida no mesmo prazo. A coluna `Elegibilidade da Bruna` explica por que uma caixa não está disponível; falta de texto seguro aparece como `SEM SUGESTÃO PRONTA`, nunca como célula vazia. Esta ampliação está publicada no Apps Script v118 desde 23/08/2026.
