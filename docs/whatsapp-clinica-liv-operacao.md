...
> **Conteúdo indisponível no webhook — candidata local de 22/08/2026:** o diagnóstico ao vivo confirmou uma mensagem exibida no aplicativo, mas entregue pela YCloud como `messageType=unsupported`, sem corpo ou referência utilizável. O ingresso permaneceu auditável em `route_pending`, sem oportunidade nem classificação, e as novas tentativas do mesmo evento foram deduplicadas. A candidata `2026-08-22.1` preserva esse roteamento conservador e passa a enviar uma única pergunta neutra para recuperar o procedimento ou a dúvida; não tenta reconstruir o texto ou o anúncio, não registra uma fala inexistente e não cria lead por inferência. O marcador da mensagem mais recente também cobre esse formato, e o log guarda somente `inboundAvailability`, subtipo e até cinco códigos técnicos, sem nome, telefone ou conteúdo. Testes do Netlify: **635/635**; a suíte ampla passou em 950 testes e encontrou uma falha preexistente e alheia ao bot na versão de um ativo de tracking de página. Nenhuma mensagem real foi enviada. A produção permanece em `2026-08-20.4` até a publicação do commit candidato; rollback previsto para o deploy `6a879f71c5efe0ad12609a3d` e commit `dd93f1cebf5c218672d1bf84d6d3b39ca3c9ff74`.
