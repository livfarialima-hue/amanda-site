...
**Atualizado em:** 30 de agosto de 2026, 14:03, America/Sao_Paulo
...
**Estado geral:** a Central prática e a Bruna estão publicadas no Apps Script v130 e no Netlify `6a90650200aa2400081284ce`, preservando os deployments canônicos e a arquitetura modular. A fila continua abrindo o WhatsApp diretamente, preservando texto e horário editados, sugerindo a melhor janela ao aprovar sem enviar e mantendo o histórico recente. Aprovação, cancelamento, limite de duas retomadas, template tardio, opt-out, preços, agenda e revisão semântica continuam sob as mesmas travas. Depois de saída humana, a equipe conserva preferência mínima de dez minutos e a Bruna relê os turnos atuais antes de responder; agora essa leitura respeita o horário real do provedor, mesmo quando ecos terminam fora de ordem. Confirmações de madrugada que prometam retorno mantêm uma pendência efetiva para as 8h, com fallback humano visível em caso de bloqueio. Continuidade sem reapresentação, nomes pessoais validados, resposta curta ao valor da consulta, deduplicação de fotos, revisão obrigatória de menores e bloqueio de identificadores internos permanecem ativos. Código funcional da Bruna `39227ac203a4a22b358734e8c37fad9f19274a12`; correções das retomadas da Central `82ea30d4b0071a777b5c2a1f60ac63d084d5b916`, `472d55d42f7ebc983f984e1538cbdf58adffcce7` e `8907c3102f79116df2c232eaafff6231bdf3482c`. Nenhuma mensagem real foi enviada.
...
**Projeção deste Plano Executivo no Drive:** o mesmo arquivo canônico remoto `18iUqY6HttJwPusSAA1VGmrMqqRluyjTO` foi substituído no fechamento do Apps Script v134 e relido com conteúdo normalizado idêntico ao arquivo local; nenhuma cópia concorrente foi criada.
