...
- `2026-08-18.4` está `TESTADA LOCALMENTE; PUBLICAÇÃO DEPENDE DE AUTORIZAÇÃO`: corrige a resposta curta que aceita uma oferta informativa após fala humana, com `CONTEXT-CONTINUE-01`, esclarecimento seguro, barreira de agenda e proteção contra corrida com a equipe; **826/826 testes** e build de 178 arquivos aprovados. Produção e projeções do Drive permanecem na `2026-08-18.3` até o gate de publicação, portanto a sincronização da candidata está pendente por desenho e não deve ser reconciliada por cópia manual;
...
- na produção `2026-08-18.3`, depois de uma fala da equipe, uma resposta curta ainda pode aguardar a retomada humana; a candidata `2026-08-18.4` faz a IA avaliar imediatamente a aceitação de uma oferta informativa e exige continuação ou esclarecimento semanticamente codificados, mantendo agenda e temas protegidos com a equipe;
