...
**Atualizado em:** 26 de agosto de 2026, 19:57, America/Sao_Paulo
...
**Estado geral:** a Central prática e a Bruna estão publicadas no Apps Script v130 e no Netlify `6a8f8650e288813cf709de85`, preservando os deployments canônicos e a arquitetura modular. A fila abre diretamente o WhatsApp, preserva texto e horário editados, sugere a janela de maior resposta ao aprovar sem enviar, reorganiza-se depois do processamento e mantém por 24 horas o histórico recente. Uma retomada manual fora da janela atual pode ser passada à Bruna somente pela aprovação explícita da equipe e, nesse caso, usa exclusivamente o template ativo `retomada_manual_bruna_v1`; dentro da janela, permanece o texto livre. O endpoint recalcula a janela e falha fechado sem aprovação, modo `template` ou configuração válida. Um cancelamento marcado sai das ações manuais na atualização seguinte e passa para `Cancelado recentemente`, em cinza, sem gravar `Nunca retomar`; conflito com aprovação permanece ativo para correção. A primeira retomada passa pelas travas determinísticas e por um veto semântico dos turnos recentes; a segunda e última somente reutiliza essa revisão quando o silêncio e a identidade da última retomada estão comprovados, sem qualquer fala posterior. Respostas seguras da paciente à retomada voltam ao fluxo ativo sem reapresentação. Depois de saída humana, a equipe tem preferência mínima de dez minutos desde a entrada mais recente; nova entrada reinicia o prazo, nova saída humana cancela e a Bruna relê os 20 turnos atuais antes de responder somente uma dúvida segura. Qualquer fala anterior da Bruna ou da equipe mantém a continuidade sem nova apresentação nem perguntas de descoberta já respondidas. Primeiras respostas mantêm o mesmo padrão em todos os procedimentos reconhecidos; nomes pessoais claros com decoração apenas nas bordas são limpos e usados, enquanto perfis ambíguos continuam rejeitados e, no primeiro contato sem nome confiável nem histórico, a Bruna atende à intenção antes de perguntar apenas `Como posso te chamar?`. A resposta ao valor da consulta presencial informa primeiro R$ 500 e evita repetir explicação da avaliação ou localização já apresentadas. Rajadas de fotos recebem no máximo uma confirmação automática, mesmo com execuções concorrentes. Crianças e menores permanecem em revisão humana obrigatória; referências de campanha e identificadores operacionais não chegam às respostas do paciente. Código funcional da Bruna `7507365726e354a4c3a447c06c552990e6667228`; correções das retomadas `82ea30d4b0071a777b5c2a1f60ac63d084d5b916`, `472d55d42f7ebc983f984e1538cbdf58adffcce7` e `8907c3102f79116df2c232eaafff6231bdf3482c`. Nenhuma mensagem real foi enviada.
...
**Projeção deste Plano Executivo no Drive:** o mesmo arquivo canônico remoto `18iUqY6HttJwPusSAA1VGmrMqqRluyjTO` foi substituído no fechamento do Apps Script v130 e relido com conteúdo normalizado idêntico ao arquivo local; nenhuma cópia concorrente foi criada.
