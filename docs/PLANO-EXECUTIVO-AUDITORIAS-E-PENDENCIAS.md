...
**Atualizado em:** 19 de agosto de 2026, 08:54, America/Sao_Paulo
...
**Estado geral:** produção contextual `2026-08-19.1` publicada e verificada em 19/08, com uma única fonte ativa no Drive, commit funcional, remoto, Netlify e Apps Script v101 reconciliados. A publicação da versão `2026-08-19.2` foi autorizada e está em andamento; o candidato reconhece `valores` no plural, aplica a resposta progressiva aprovada de cervicoplastia e envia um único guia de composição na região correta — facial, mama ou corporal — na primeira pergunta de preço. A IA continua sendo a primeira instância de compreensão nas mensagens textuais elegíveis, sob as travas clínicas e operacionais existentes; nenhuma mensagem real de paciente foi enviada e nenhuma configuração do Google Ads foi alterada.
...
- `2026-08-19.2 — PUBLICAÇÃO AUTORIZADA E EM ANDAMENTO`: a pergunta `E gostaria de saber os valores` passa a acionar a resposta inicial cervical aprovada, sem números; toda primeira pergunta de preço com procedimento confiável recebe no máximo um guia regional — facial para face/pescoço, mama para cirurgias mamárias e corporal para corpo/íntima — e esse link não se repete no turno da faixa. O aceite cervical posterior autoriza uma única faixa com ressalvas; sem guia facial anterior, a página específica de lifting entra como fallback. Outras faixas, repetição, agenda e contexto humano permanecem protegidos. **865/865 testes**, build de 178 arquivos e 44 URLs aprovados; o Apps Script permanece na v101;
...
- na versão `2026-08-19.2` em publicação, a primeira pergunta sobre preço cirúrgico recebe resposta breve e empática, sem lista técnica ou faixa, mais um único guia de composição conforme a região confirmada; nunca se usa o guia facial para mama, corpo ou cirurgia íntima, e o material não é repetido no turno da faixa. A pergunta sobre o que mais incomoda continua proibida nesse momento, e as travas de revisão humana foram preservadas;
...
- código ativo no commit funcional `35b4b5a3d7f5e33cdebfe9d904a75843264ac5fe`, deploy Netlify `6a858294fc30270008e0964a` e Apps Script v101, com **851/851 testes aprovados**, build local de 178 arquivos, 44 URLs sem erro, site, webhook e web app HTTP 200 e metadados de versão `.1` efetivos; rollback imediato para Apps Script v100, deploy `6a84facdbed81175d2df0107`, commit `6fd37c3227e6fee1ca4ea1686248cb22733040f1`;
- fonte ativa única no Drive: https://drive.google.com/file/d/17eOwn4Z7v7josBnnPJhBHn31wY-2P1YF/view; projeção substituída no mesmo ID e igual ao manual local pelo SHA-256 `363e3b887b9b50c8074e4a3e6ae8d30c4d240e2a41c65c19d88696295456b753`; auditoria comparativa fechada: https://drive.google.com/file/d/1Fw12uukeIa2qKx-a-teI9BQhobNUdHVB/view; os três planos de origem foram preservados e rotulados em `99 — Histórico operacional`;
...
- rollback imediato do estado atual: deploy `6a84dea1cf780e00086eed7e`, commit `c392a743b2f00d751bf6dca8da54b991db0439ff`.
