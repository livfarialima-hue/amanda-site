...
**Atualizado em:** 23 de agosto de 2026, 14:40, America/Sao_Paulo
...
**Estado geral:** a Central prática e a Bruna estão publicadas no Apps Script v124 e no Netlify `6a8b2f26fc9c880f38e8e745`, preservando os deployments canônicos. A fila abre diretamente o WhatsApp, preserva texto e horário editados, sugere a janela de maior resposta ao aprovar sem enviar, reorganiza-se depois do processamento e mantém por 24 horas o histórico recente. Antes do provedor, a retomada passa pelas travas determinísticas e por um veto semântico dos 20 turnos recentes; a Bruna só entrega o texto exato com alta confiança e falha fechada diante de mudança, resposta, procedimento incompatível, ambiguidade, tema sensível ou indisponibilidade. Respostas seguras da paciente à retomada voltam ao fluxo ativo sem reapresentação. Código funcional `f3966f76d281056fc1abf5198a9a97ea519ed6ff`; **1006/1006 testes**, build de 178 arquivos e 44 URLs aprovados. Nenhuma mensagem real foi enviada.
...
**Candidata integrada `2026-08-23.4` — AUTORIZADA, PUBLICAÇÃO EM ANDAMENTO:** preserva integralmente a v124 e acrescenta dois comportamentos delimitados. A segunda e última retomada aprovada pode reutilizar a revisão semântica anterior somente quando o silêncio e a identidade da última retomada estiverem comprovados; qualquer atividade ou falta de prova chama a IA novamente e falha fechada. As respostas automáticas de preço ficam estritamente separadas: lifting facial preserva sua faixa própria; cervicoplastia informa exclusivamente **R$ 18 mil a R$ 26 mil**; otoplastia permanece automática em **R$ 8 mil a R$ 14 mil**. Perguntas de preço de qualquer outra cirurgia seguem para revisão humana desde a primeira ocorrência, com alerta interno e resposta sugerida, e nenhum texto à paciente expõe linguagem de confirmação operacional interna. Validação local: **313/313 testes focados**, **1015/1015 testes integrais**, build de 178 arquivos e 44 URLs. Não houve mensagem real. Pendências deste ponto: commit intencional, publicação do commit aprovado, pós-voo sintético e substituição das projeções canônicas no Drive.

**Página de preço do lifting — AUTORIZADA, PUBLICAÇÃO EM ANDAMENTO:** o guia continua sem qualquer faixa numérica pública e passa a oferecer, no WhatsApp, uma conversa privada sobre faixa geral informativa como ponto de partida, sempre distinguida de orçamento, proposta ou garantia. O prefill estruturado `price_range_reference`, os três CTAs principais e o rastreamento foram validados; os três assets de tracking usam a versão única `20260823-price-range-1` nas 44 páginas públicas para evitar cache divergente. Nenhuma campanha, orçamento, lance, palavra-chave ou anúncio foi alterado por este pacote.
...
**Projeção deste Plano Executivo no Drive:** o mesmo arquivo canônico remoto `18iUqY6HttJwPusSAA1VGmrMqqRluyjTO` foi substituído no fechamento da versão `2026-08-23.3`; nenhuma cópia concorrente foi criada.
