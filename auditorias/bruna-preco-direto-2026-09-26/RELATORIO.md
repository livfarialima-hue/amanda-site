...
Pré-voo em PREFLIGHT.json; publicação, domínio, endpoint imutável, assinatura e hashes das projeções serão registrados em PUBLICACAO.json. Nenhuma mensagem antiga será reprocessada. Aumento de conversão não foi medido e publicação técnica não comprova entrega de uma nova conversa natural.
