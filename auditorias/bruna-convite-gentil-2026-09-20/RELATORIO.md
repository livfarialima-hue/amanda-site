...
Texto aprovado por Daniel nesta tarefa:

> Obrigada pela confiança na Dra. Amanda. Foi um prazer receber você!
> 
> Se quiser contar como foi sua experiência, deixo aqui o link para avaliar o atendimento no Google: https://search.google.com/local/writereview?placeid=ChIJ7-dPJgtXzpQRMfKy91PM_qs
> Seu relato pode ajudar quem também está escolhendo com quem se cuidar.

O transporte existente acrescenta a abertura “Retomando nosso contato pela Clínica LIV:” e a opção de não receber novas mensagens. O corpo acima permanece completo, sem corte e com link em texto simples, compatível com WhatsApp. Nenhum modelo externo foi alterado.

A mudança é de redação. Os critérios de convite e o envio após aprovação individual permanecem os da versão 2026-09-20.2. A verificação usa cenários sintéticos; nenhum convite real é enviado pela tarefa.
