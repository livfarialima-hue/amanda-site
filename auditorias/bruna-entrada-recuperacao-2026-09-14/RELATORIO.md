...
## Pendências técnicas já concluídas

A leitura das três chaves mostrou comprovantes terminais anteriores coexistindo com pending. O claim agora confere esse comprovante e remove somente a chave pendente canônica do mesmo evento, antes de executar qualquer handler. A conclusão idempotente também limpa esse resíduo. As duas novas regressões com SDK real falharam antes da correção. Resultado final: 1.537/1.537 testes integrais e 43/43 focados. Este último ajuste apenas reconcilia a fila técnica com comprovantes existentes; não reabre efeito ou mensagem. Os mecanismos de efeito foram publicados default-off e verificados na etapa anterior.
